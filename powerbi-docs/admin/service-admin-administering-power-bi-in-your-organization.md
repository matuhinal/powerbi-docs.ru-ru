...
| --- | --- | --- |
| глобального администратора; | Microsoft 365 | Может управлять всеми аспектами клиента Power BI и других служб. |
| администратора выставления счетов; | Microsoft 365 | Может приобретать лицензии Power BI через подписки Office 365. |
...
Глобальные администраторы Microsoft 365 или Azure Active Directory имеют права администратора в Power BI. Глобальный администратор может назначать другим пользователям роль администратора службы Power BI, которая предоставляет права администратора только для Power BI.
...
Роль администратора службы Power BI не дает возможности назначать пользователям лицензии или просматривать журналы аудита в Microsoft 365. Таким образом, функции администрирования Power BI пока нельзя полностью возложить на пользователей, которым назначена только роль администратора службы Power BI.

## <a name="administrative-tasks"></a>Задачи администрирования

Администраторы выполняют многие задачи, связанные с поддержкой Power BI в своей организации. Эти задачи перечислены в следующей таблице.
...
| Управление ресурсами Power BI |<ul><li>Управление рабочими областями<br><li>Публикация визуальных элементов Power BI<br><li>Проверка кодов, используемых для внедрения Power BI в другие приложения|
...
| --- | --- |
| Портал администрирования Power BI |<ul><li>Приобретение и применение емкости Premium</li><li>Обеспечение качества обслуживания</li><li>Управление классификацией бизнес-данных</li><li>Помощь в применении политик публикации и совместного использования содержимого</li><li>Управление рабочими областями<br><li>Публикация визуальных элементов Power BI</li><li>Проверка кодов, используемых для внедрения Power BI в другие приложения</li><li>Устранение неполадок с доступом к данным и решение других проблем</li></ul>|
...
Мы надеемся, что эта статья помогла вам получить общее представление о работе администраторов Power BI и связанных с ней ролях, задачах и средствах. Для получения дополнительных сведений мы рекомендуем следующие статьи.
