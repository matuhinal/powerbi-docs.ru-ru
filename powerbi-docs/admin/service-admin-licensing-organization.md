...
Если вы не хотите, чтобы самостоятельная регистрация была доступна для пользователей в вашей организации, см. инструкции по ее отключению в статье [Включение или отключение самостоятельной регистрации](service-admin-disable-self-service.md).
