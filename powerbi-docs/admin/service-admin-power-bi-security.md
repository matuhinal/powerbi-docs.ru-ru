...
![Схема, показывающая архитектуру Power BI для кластера клиентского веб-интерфейса.](media/service-admin-power-bi-security/pbi_security_v2_wfe.png)
...
![Схема, показывающая архитектуру Power BI для кластера серверного веб-компонента.](media/service-admin-power-bi-security/pbi_security_v2_backend_updated.png)
