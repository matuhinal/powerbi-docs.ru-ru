...
| **Автоматическое обновление страницы** | Переключатель "вкл./выкл.", позволяющий настраивать для рабочих областей "Премиум" отчеты с автоматическим обновлением страницы на основе фиксированных интервалов. |
...
| **Мера обнаружения изменений** | Переключатель "вкл./выкл.", позволяющий настраивать для рабочих областей "Премиум" отчеты с автоматическим обновлением страницы на основе обнаружения изменений. |
| **Минимальный интервал выполнения** | Если мера обнаружения изменений включена, это минимальный интервал выполнения, разрешенный для опроса изменений данных. Значение по умолчанию — пять секунд, а минимально допустимое значение — одна секунда. |
|  |  |  |
...
Рабочие нагрузки можно включить и назначить емкости с помощью REST API [емкостей](/rest/api/power-bi/capacities).
