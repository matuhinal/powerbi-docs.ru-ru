...
|  |Использование метрик для отчетов и панелей мониторинга|Доступно|Доступно|Доступно|
|  |Совместная работа Azure B2B между GCC и коммерческим облаком<sup>1</sup>|Доступно|Недоступно|Недоступно|
...
|  |Отчеты с разбивкой на страницы|Доступно|Доступно|Доступно|
...
|Интеграция между продуктами|Внедрение в SharePoint Online с использованием веб-части Power BI|Доступно|Недоступно|Недоступно|
