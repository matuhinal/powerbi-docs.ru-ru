...
| Интеграция Microsoft 365 | **GCC**: [Конечные точки по всему миру](https://docs.microsoft.com/microsoft-365/enterprise/urls-and-ip-address-ranges) |
| | **GCC High**: [Конечные точки US Government GCC High](https://docs.microsoft.com/microsoft-365/enterprise/microsoft-365-u-s-government-gcc-high-endpoints) |
| | **DoD**: [Конечные точки US Government DOD](https://docs.microsoft.com/microsoft-365/enterprise/microsoft-365-u-s-government-dod-endpoints) |
...
Дополнительные сведения об облачных службах Microsoft Azure для государственных организаций см. в [документации по Azure для государственных организаций](https://docs.microsoft.com/azure/azure-government/).
