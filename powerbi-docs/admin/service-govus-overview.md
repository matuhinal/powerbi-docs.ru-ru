...
|[Внедрение в SharePoint Online с использованием веб-части Power BI](/esharepoint/dev/spfx/web-parts/overview-client-side-web-parts)|![доступен](../media/yes.png)|![Доступно](../media/yes.png)|![недоступно](../media/no.png)|
