...
Метки конфиденциальности и параметры защиты не применяются при экспорте данных в CSV- или PBIX-файлы, в "Анализ в Excel" или по любому другому пути экспорта.
...
В бизнес-приложения, такие как Microsoft Teams и SharePoint, или на веб-сайт организации можно внедрять отчеты, панели мониторинга и визуальные элементы Power BI. При внедрении визуального элемента, отчета или панели мониторинга, к которым применена метка конфиденциальности, эта метка будет видна во внедренном представлении и будет сохраняться при экспорте данных в Excel вместе с параметрами защиты.
