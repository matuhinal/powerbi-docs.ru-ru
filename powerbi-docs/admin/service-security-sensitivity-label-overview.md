...
Метки конфиденциальности и шифрование файлов **не применяются** к неподдерживаемым путям экспорта. Администратор Power BI может блокировать экспорт из неподдерживаемых путей экспорта:
