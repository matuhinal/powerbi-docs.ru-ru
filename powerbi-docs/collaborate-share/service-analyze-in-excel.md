...
## <a name="two-ways-to-get-started"></a>Два способа начать работу
Существует два разных способа исследовать наборы данных Power BI в Excel. Если вы начинаете с Power BI, выполните действия, описанные в этом документе.  Кроме того, теперь пользователи с определенными SKU Office могут обращаться к своим наборам данных непосредственно из книги Excel.  Они могут просматривать наборы данных, к которым у них есть доступ, видеть, были ли они сертифицированы или продлены, а также были ли применены метки защиты данных.  Дополнительные сведения об этой операции см. в разделе [Создание сводной таблицы из наборов данных Power BI](https://support.office.com/article/31444a04-9c38-4dd7-9a45-22848c666884) в документации по Excel.
...
* Гостевым пользователям недоступна команда **Анализировать в Excel** для наборов данных, отправленных из другого клиента. 
...
## <a name="get-started-with-analyze-in-excel-in-power-bi"></a>Приступая к анализу в Excel в Power BI
