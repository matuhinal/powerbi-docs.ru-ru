...
| Отчеты об использовании | Rank | Рейтинг показывает популярность того или иного отчета по сравнению со всеми остальными отчетами в организации на основе подсчета просмотров.   |
...
1. Выберите **Изменить учетные данные** в разделе **Учетные данные источника данных**
    ...
    ![Изменение учетных данных](media/service-modern-usage-metrics/power-bi-usage-metrics-edit-credentials.png)
