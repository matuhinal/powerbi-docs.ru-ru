...
Кэш сохраняется в течение длительного времени. При обновлении определения отчета (например, при изменении режима просмотра) или обновлении данных отчета изменения будут отражены в версии отчета, просматриваемой пользователями, приблизительно через час. Поскольку каждый элемент и значение данных кэшируются независимо, при обновлении данных пользователь может видеть сочетание текущих и предыдущих значений. Поэтому мы рекомендуем заранее планировать и организовывать работу и создавать код внедрения для **публикации в Интернете** только в том случае, если вас устраивают все параметры. Если данные будут обновляться, сократите количество обновлений и выполняйте их в нерабочее время.
