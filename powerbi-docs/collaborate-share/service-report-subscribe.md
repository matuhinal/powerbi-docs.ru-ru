...
2. В верхней строке меню выберите **Подписаться** или нажмите значок конверта :::image type="icon" source="media/service-report-subscribe/power-bi-icon-envelope.png" border="false":::.
...
- Подписки на рассылку по электронной почте не поддерживают большинство [пользовательских визуальных элементов](../developer/visuals/power-bi-custom-visuals.md). Единственным исключением являются [сертифицированные](../developer/visuals/power-bi-custom-visuals-certified.md) пользовательские элементы.
...
- Предположим, у вас есть отчет с активным подключением к Analysis Services и подписка, настроенная для запуска после обновления данных. Впервые он будет выполнен, когда служба Power BI обнаружит изменение в локальной модели при опросе экземпляра Analysis Services.  Power BI ежечасно выполняет проверку на наличие изменений в модели данных Analysis Services, чтобы определить, когда следует отправлять подписку.
