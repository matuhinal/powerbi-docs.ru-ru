...
![Снимок экрана: диалоговое окно параметров, в котором отображаются параметры DirectQuery](media/desktop-directquery-sap-hana/directquery-sap-hana_01a.png)
...
![На диаграмме представлен запрос, определенный в редакторе запросов, который возвращает значение средней цены по ProductID.](media/desktop-directquery-sap-hana/directquery-sap-hana_01.png)
...
![Снимок экрана: пример запроса с запросом SQL к SAP HANA](media/desktop-directquery-sap-hana/directquery-sap-hana_03.png)
