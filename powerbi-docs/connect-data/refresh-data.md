...
> [!NOTE]
> Обновление набора данных в Power BI может занять до 10 минут, даже после завершения синхронизации на локальном компьютере и выполнения действия *Обновить сейчас* в службе Power BI.
