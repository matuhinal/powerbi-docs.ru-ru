...
**Вопрос**. Можно ли использовать библиотеку msmdpump.dll для создания настраиваемого сопоставления действующих имен пользователей для Analysis Services? 
