...
Поэтому, если вы не можете открыть приложение, обратитесь к администратору или в службу поддержки. Сведения о лицензировании см. в разделе [Лицензирование Power BI](end-user-license.md).
...
4. Если вы нашли нужное приложение, выберите **Получить сейчас** , чтобы установить.

   ![Снимок экрана с кнопкой "Получить"](./media/end-user-app-view/power-bi-get-now.png)
...
Вы также можете установить приложение организации по прямой ссылке.    
...
Изучите данные на панелях мониторинга и в отчетах, входящих в состав приложения. Вам доступны все стандартные возможности взаимодействия Power BI, такие как фильтрация, выделение, сортировка и детализация.  Доступные в приложении возможности зависят от разрешений, назначенных вам *конструктором* .  Способ работы с панелями мониторинга и отчетами приложения определяется правами доступа и ролями, назначенными вам *конструктором* . 

Все еще немного путаете панели мониторинга и отчеты?  Прочите [статью о панелях мониторинга](end-user-dashboards.md) и [статью об отчетах](end-user-reports.md).  
...
![Снимок экрана со списком содержимого "Приложения"](./media/end-user-app-view/power-bi-apps-card.png)
...
![Снимок экрана: указатель мыши, наведенный на приложение, с указанием имени, метки времени, владельца и действий ](./media/end-user-app-view/power-bi-app-hover.png)
...
![Снимок экрана: приложение "Продажи и маркетинг" с разными областями, обозначенными числами ](./media/end-user-app-view/power-bi-app-number.png)
...
1. Панель навигации приложения.  Под именем приложения находится список содержимого. Это приложение содержит один шестистраничный отчет. Выберите имя страницы отчета, чтобы открыть ее. Сейчас мы открыли страницу *Частота возврата* . 
1. Выберите стрелку, чтобы развернуть область **Фильтры** .

Вы также можете просмотреть связанную рабочую область, если вам предоставлен доступ.  При установке или загрузке шаблона приложения служба Power BI создает рабочую область. При установке приложения организации, в нем может быть не предусмотрен доступ к рабочей области. [Сведения о рабочих областях](end-user-workspaces.md) Выберите **Power BI** (номер 2), чтобы вернуться на страницу **Главная** и выбрать **Рабочие области** . 

![Снимок экрана: рабочая область "Продажи и маркетинг", в которой показаны один отчет и один набор данных ](./media/end-user-app-view/power-bi-new-workspace.png)
...
* Если вы получили шаблон приложения из AppSource, при следующем его открытии вы увидите баннер с уведомлением. В нем сообщается о доступности новой версии. 
    ...
    2. Когда будет предложено установить обновленное приложение, нажмите **Установить** . 
        ...
        ![Установка обновления](./media/end-user-app-view/power-bi-installs.png) 
    ...
    3. Так как у вас уже есть версия этого приложения, решите, нужно ли заменить существующую версию или установить обновленное приложение в новой рабочей области.   
     ...
     > [!NOTE] 
     > При установке новой версии все изменения, внесенные в отчеты и панели мониторинга приложения, перезаписываются. Чтобы сохранить измененные отчеты и панели мониторинга, можно сохранить их с другими именами или в другом месте перед установкой. 
...
- Для использования приложений требуется лицензия Pro или подписка уровня "Премиум", чтобы приложение хранилось в рабочей области в общей емкости. [Сведения о лицензиях](end-user-license.md).
