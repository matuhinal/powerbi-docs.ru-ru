...
* Если вы устанавливаете приложение-шаблон, вы будете перенаправлены к приложению-шаблону, предлагаемому в AppSource. См. [пример](end-user-app-marketing.md) скачивания и установки примера приложения-шаблона из Marketplace для приложений Power BI. Приложение устанавливается вместе с рабочей областью с таким же именем.
   ...
   > [!NOTE]
   > Если у вас есть бесплатная лицензия пользователя, вы сможете скачивать приложения, но не просматривать их. Для этого нужно обновиться до учетной записи Power BI Pro или сохранить приложение в общей емкости "Премиум". См. сведения о [лицензиях для потребителей](end-user-license.md).
...
Если щелкнуть эту ссылку в письме, служба Power BI ([https://powerbi.com](https://app/powerbi.com)) откроет приложение в браузере. 
...
Также можно просмотреть связанную рабочую область. [Сведения о рабочих областях](end-user-workspaces.md)
