...
[Отчеты](end-user-reports.md) зачастую путают с панелями мониторинга, так как они также являются полотнами, которые заполнены визуализациями. Но есть некоторые существенные различия.
...
* Ознакомьтесь с информацией о [плитках панели мониторинга](end-user-tiles.md) и разных способах их закрепления на панели мониторинга.
