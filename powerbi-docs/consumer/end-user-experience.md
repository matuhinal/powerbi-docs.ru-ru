...
![Экран "Моя рабочая область"](./media/end-user-experience/power-bi-my-workspace2.png)
...
![поиск панели мониторинга](./media/end-user-experience/power-bi-search-sort.png)

Вы также можете сортировать содержимое по имени или владельцу.  

![сортировка содержимого](./media/end-user-experience/power-bi-sort.png)

Дополнительные сведения см. в статье [Поиск и сортировка содержимого в Power BI](end-user-search-filter-sort.md).
...
> [Режимы чтения и правки в службе Power BI](end-user-reading-view.md)