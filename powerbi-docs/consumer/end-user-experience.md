...
Выберите рабочую область на панели навигации, после чего вкладки для соответствующего содержимого (панелей мониторинга, отчетов, книг, наборов данных) заполнят холст Power BI в правой части.
...
2. Чтобы отобразить список всего содержимого, добавленного в избранное, на панели навигации щелкните стрелку справа от пункта **Избранное**. Панель навигации — постоянная функция службы Power BI, поэтому этот список доступен из любого расположения в службе.
...
3. Откройте *панель* **Избранное**, выбрав **соответствующий пункт** на панели навигации слева или щелкнув значок звездочки ![снимок экрана, на котором показан желтый значок звездочки](media/end-user-experience/powerbi-star-icon.png).
...
1. Как и в случае с избранным, вы можете быстро открывать последнее содержимое откуда угодно в службе Power BI, щелкнув стрелку рядом с пунктом **Последние** на панели навигации.
...
2. На панели навигации выберите **Рабочие области > Моя рабочая область**.  
