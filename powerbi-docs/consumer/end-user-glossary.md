...
**containter** (контейнер). Область навигации состоит из *контейнеров*. В области навигации доступны следующие контейнеры: "Избранное", "Последние", "Приложения", "У меня есть доступ" и "Главная страница". 
...
**navigation pane** **(область навигации)** . Элементы управления в левой части службы Power BI.

Иногда может также встречаться название "панель навигации".

**nav pane** (область навигации). См. **navigation pane**.
