...
**Desktop**. При первом упоминании — Power BI Desktop, при последующих упоминаниях — Desktop.
...
**gateways** (шлюзы) или **on-premises data gateways** (локальные шлюзы данных). Мост к выделенным источникам данных. Он обеспечивает быструю и безопасную передачу данных между службой Power BI и локальными источниками данных, поддерживающими обновление. Обычно управляется ИТ-специалистами. on-premises data gateways (локальные шлюзы данных)
...
**Power BI**, **Power BI service** (служба Power BI), **Power BI Desktop**, **Power BI mobile**. Некоторые из предложений Power BI. *Power BI* — это общий термин. Он часто используется вместо полного названия продукта, такого как *служба Power BI* и *Power BI mobile*, после первого упоминания полного названия.

**Power BI Desktop**. Также называется *Desktop*.
...
**Power BI Report Server** (сервер отчетов Power BI). Новое предложение запуска служб SSRS с Power BI Premium, позволяющее организациям создавать распределенные, гибридные системы бизнес-аналитики (сочетание облачных и локальных развертываний).
Это предложение построено на SQL Server Reporting Services с их широкими возможностями создания отчетов с разбивкой по страницам и обеспечивает мобильные отчеты с возможностью обслуживать отчеты Power BI, разработанные с помощью Power BI Desktop, а также доставлять их в мобильных приложениях Power BI. Классические службы SSRS по-прежнему продаются.
