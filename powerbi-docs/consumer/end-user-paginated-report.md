...
ms.locfileid: "91983269"
---
# <a name="paginated-reports-in-the-power-bi-service"></a>Отчеты с разбивкой на страницы в службе Power BI

[!INCLUDE[consumer-appliesto-yyny](../includes/consumer-appliesto-yyny.md)]

Вы уже ознакомились с [отчетами Power BI](end-user-reports.md). Именно такие отчеты вам будут встречаться чаще всего. Отчеты Power BI оптимизированы для исследования данных и интерактивных возможностей. В формате отчета Power BI лучше создавать, например, отчет о продажах с возможностью выборки данных по конкретным регионам, отраслям и клиентам и с мгновенным отображением соответствующих подытогов.

Однако есть и другой тип отчетов, который называется *отчеты с разбивкой на страницы* . Для получения и просмотра отчетов с разбивкой на страницы требуется лицензия Power BI Pro для сохранения отчета в емкости Premium.  [Сведения о лицензиях](end-user-license.md).  
...
![Список отчетов с одним стандартным отчетом и одним отчетом с разбивкой на страницы.](./media/end-user-paginated-report/power-bi-report-lists.png)

## <a name="what-is-a-paginated-report"></a>Что такое отчет с разбивкой на страницы

Под термином *с разбивкой на страницы* подразумевается то, что формат отчетов подбирается с учетом отображения на печатаемых страницах. Одним из преимуществ является то, что все данные отчета отображаются в таблице, даже если для этого потребуется много страниц. Иногда в качестве названия для отчетов с разбивкой на страницы употребляют описательное выражение "с точностью до пикселя". Это означает, что *разработчики* точно настраивают макет отчета.

Отчеты с разбивкой на страницы подходят в тех случаях, когда важны широкая поддержка форматирования и идеальная попиксельная оптимизация для печати или создания PDF. Например, отчет с разбивкой на страницы будет оптимальным вариантом организации результатов финансовой деятельности организации.

## <a name="how-do-paginated-reports-work"></a>Как работают отчеты с разбивкой на страницы?
...
Выберите отчет с разбивкой на страницы, чтобы открыть его в службе Power BI. Если отчет имеет параметры, выберите их, чтобы перейти к просмотру отчета.

   ![Параметры отчета](./media/end-user-paginated-report/power-bi-select-parameters.png)
...
![Простой отчет с одним параметром](./media/end-user-paginated-report/power-bi-one-parameter.png)
...
![отчет с тремя параметрами](./media/end-user-paginated-report/power-bi-parameter-bar.png)
...
![изменение параметров](./media/end-user-paginated-report/power-bi-orders.png)

Отобразится новый заказ на продажу в соответствии с выбранными параметрами. 

![новый заказ на продажу](./media/end-user-paginated-report/power-bi-new-orders.png)
...
![элементы управления страницами](./media/end-user-paginated-report/power-bi-page-control.png)
...
![Снимок экрана: экспортированный отчет с разбивкой на страницы.](./media/end-user-paginated-report/power-bi-export-choices.png)
...
![Форматы для подписки](./media/end-user-paginated-report/power-bi-export-choices.png)
