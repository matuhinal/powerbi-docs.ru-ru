...
description: Печать панели мониторинга, плитки или страницы отчета в службе Power BI.
author: mihart
manager: kvivek
ms.reviewer: ''
featuredvideoid: ''
...
2. В левом верхнем углу выберите Экспорт и выберите **распечатать эту страницу**.
...
1. Откройте панель мониторинга в [полноэкранный режим](end-user-focus.md) , выбрав соответствующий значок ![значок полноэкранного режима](./media/end-user-print/power-bi-full-screen-icon.png) в верхнем меню.
3. [Откройте плитку в режиме фокусировки](end-user-focus.md) , проведите, чтобы отобразить многоточие (...) Выбор **открыть в режиме фокусировки** или значок фокусировки ![значок фокусировки](./media/end-user-print/power-bi-focus-icon.png).
...
1. Откройте отчет и выберите **Экспорт** > **печати** Чтобы напечатать текущую страницу отчета.
...
2. В левом верхнем углу выберите **Экспорт** > **печати** печать визуального элемента.
...
* Ответ. Мы не гарантируем, что печатные копии будут совпадать как оно отображается в службе Power BI. Power BI не позволяет управлять такими параметрами, как масштабирование, поля, сведения о визуальных элементах, ориентация и размер. Справку по подобным вопросам см. в документации к конкретному браузеру.      
