...
Режим правки доступен только для пользователей, создавших отчет или [совместно владеющих отчетом как участник или администратор рабочей области приложения](end-user-create-apps.md).
...
| [Удаление отчета](end-user-delete.md) | Нет  | Да |
|**Страницы отчета** |
...
| [Удаление страницы отчета](end-user-delete.md) | нет | да |
...
| [Удаление визуализации, текстового поля или фигуры](end-user-delete.md)| Нет | Да |
