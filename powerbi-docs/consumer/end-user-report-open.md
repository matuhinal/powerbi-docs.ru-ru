...
*Разработчики отчетов* Power BI могут предоставить вам прямой доступ к отдельному отчету, указав ссылку в сообщении электронной почты или автоматически добавив его. Предоставляемое таким образом содержимое отображается в контейнере **Мне предоставлен доступ** в области навигации, а также в разделе **Мне предоставлен доступ** на холсте главной страницы.
...
Если вы получали приложения от коллег или из AppSource, они будут доступны на главной странице и в контейнере **Приложения** в области навигации. [Приложения](end-user-apps.md) представляет собой набор панелей мониторинга и отчетов.
...
- из области навигации с помощью элементов **Избранное** и **Недавние**;    
