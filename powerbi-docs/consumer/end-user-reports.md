...
Этот отчет содержит четыре страницы (или вкладки); вы просматриваете страницу **Тональность**. На этой странице отображается пять различных визуальных элементов и заголовок.
...
[Основные понятия для потребителей службы Power BI](end-user-basic-concepts.md)