...
description: Отчеты в служба Power BI для бизнес-пользователей
author: mihart
ms.reviewer: mihart
ms.service: powerbi
...
> [!NOTE]
> Помните, что вы не можете повредить данные. Служба Power BI отлично подходит для исследований и экспериментов. Вы можете спокойно работать, не боясь что-нибудь испортить.
...
## <a name="report-designers-and-report-users"></a>Создатели отчетов и пользователи отчетов
...
Вы можете также быть *бизнес-пользователем* , использующим отчеты, полученные от других. Возможно, вы хотите разобраться в особенностях использования отчетов и способах взаимодействия с ними. Если вы являетесь *бизнес-пользователем* отчетов, вам нужны эти ссылки.

* Начните с [обзора службы Power BI](end-user-basic-concepts.md), чтобы узнать, где находятся отчеты и средства их создания.
* Узнайте, как [открыть отчет](end-user-report-open.md), а также узнайте обо [всех действиях, доступных бизнес-пользователям](end-user-reading-view.md).
