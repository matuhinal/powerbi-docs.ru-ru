---
title: Подписка на отчеты и панели мониторинга для потребителей Power BI
description: Узнайте, как оформить для себя подписку на моментальные снимки отчета и панели мониторинга Power BI по электронной почте.
author: mihart
manager: kvivek
ms.reviewer: ''
featuredvideoid: ''
