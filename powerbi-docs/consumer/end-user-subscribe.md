...
* Подписки на рассылку по электронной почте не поддерживают большинство [визуальных элементов Power BI](../developer/visuals/power-bi-custom-visuals.md).  Исключением являются [сертифицированные](../developer/visuals/power-bi-custom-visuals-certified.md) визуальные элементы Power BI.  
