---
title: Типы визуальных элементов в Power BI для бизнес-пользователей
...
Конструкторы отчетов могут создать приложение Power и внедрить его в отчет Power BI. *Бизнес-пользователи* могут взаимодействовать с этой визуализацией в отчете Power BI. 
...
### <a name="smart-narrative"></a>Визуальный элемент с автоописанием
![визуальный элемент с автоописанием](media/end-user-visual-type/power-bi-smart-narrative.png)

Визуальный элемент с автоописанием позволяет добавить текст для выделения тенденций и основных выводов, а также добавлять объяснения и контекст. Такой текст поможет пользователям понять данные и быстро определить важные результаты.
