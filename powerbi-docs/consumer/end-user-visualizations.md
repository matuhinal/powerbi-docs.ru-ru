...
|[Просматривайте по одному визуальному элементу без рамок или областей навигации, используя *полноэкранный режим* или *режим фокусировки*](end-user-focus.md).     |   да      |  да       | по умолчанию  |
