...
Приложение Power BI Mobile для iOS и Android поддерживает параметры, позволяющие администраторам для Office 365 и служб управления мобильными устройствами (MDM), таких как Intune, настраивать поведение приложения.
