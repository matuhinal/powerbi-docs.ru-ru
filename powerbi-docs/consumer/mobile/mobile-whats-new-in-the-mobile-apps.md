...
Кроме того, ИТ-администраторы могут [удаленно переопределять новые параметры по умолчанию](./mobile-app-configuration.md#interaction-settings-android) от имени пользователей, используя предпочтительное средство MDM и файл конфигурации приложения. Таким образом можно настроить одинаковые параметры для всех пользователей в организации.
