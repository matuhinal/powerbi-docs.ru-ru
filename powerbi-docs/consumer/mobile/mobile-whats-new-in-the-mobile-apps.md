...
* [Блог команды разработчиков Power BI по мобильным приложениям](https://powerbi.microsoft.com/blog/tag/mobile/)
...
**Запрос доступа к панелям мониторинга** 
...
#### <a name="ios-devices"></a>Устройства iOS
**Предварительная версия функции "Вопросы и ответы", позволяющая задавать вопросы о ваших данных** 
...
#### <a name="all-devices"></a>Все устройства
**Обновление в фоновом режиме для автономной работы**
...
#### <a name="ios-devices"></a>Устройства iOS
**Функция "Добавить заметки и поделиться"**
