...
Теперь страницы отчета, настроенные с помощью [автоматического обновления страниц](../../create-reports/desktop-automatic-page-refresh.md), также автоматически обновляются в приложении Power BI для устройств Windows. И это не значит, что это обычное представление отчетов. Благодаря автоматическому обновлению страницы [презентаций и слайдов](mobile-windows-10-app-presentation-mode.md#slideshows) также обновляются в режиме реального времени, обеспечивая постоянное отображение последних бизнес-данных и ценных сведений.

### <a name="support-for-notch-displays-ios"></a>Поддержка дисплеев с фронтальной камерой в верхней части экрана (iOS)
Добавлена поддержка дисплеев с вырезом для камеры на iPhone и iPad, оставляющих больше места на экране для отчетов и панелей мониторинга. 

## <a name="september-2020"></a>Сентябрь 2020 г.
### <a name="power-bi-app-preview-for-hololens-2-is-out-in-the-stores"></a>Приложение Power BI (предварительная версия) для HoloLens 2 уже в магазинах!

Приложение Power BI для HoloLens 2 предоставляет взаимодействие с эффектом полного присутствия. Используя систему управления жестами HoloLens 2, вы можете получать избранные отчеты и панели мониторинга из набора, изменять их размер и размещать их в нужном месте и даже просматривать страницы отчета. Отчеты и панели мониторинга обновляются во время использования приложения, поэтому, если данные изменяются, вы сразу же увидите эти изменения. Дополнительные сведения см. в соответствующих [документации](mobile-hololens2-app.md) и [блоге](https://powerbi.microsoft.com/blog/power-bi-app-for-mixed-reality-now-available-for-hololens-2/)!
...
![Снимок экрана: дерево навигации мобильного приложения Power BI.](media/mobile-whats-new-in-the-mobile-apps/power-bi-mobile-nav-tree1.png)
...
### <a name="auto-play-a-slideshow-on-startup-windows"></a>Автоматическое воспроизведение слайд-шоу при запуске (Windows)
...
![Темный режим в мобильном приложении Power BI](media/mobile-whats-new-in-the-mobile-apps/mobile-apps-dark-mode.png)
...
Щелкните правой кнопкой мыши значок приложения Power BI на панели задач Windows, чтобы отобразить список всех недавно просмотренных элементов. Щелкните любой элемент в списке, чтобы быстро вернуться к нему.
...
* Будьте в курсе всех новых информационных панелей своих групп — получайте уведомления на iPhone каждый раз, когда член команды добавляет информационную панель в одну из групп.
    ...
    ![Снимок экрана: панель мониторинга с уведомлением на iPhone](media/mobile-whats-new-in-the-mobile-apps/pbi_iph_grpdashalertcrop.png)
