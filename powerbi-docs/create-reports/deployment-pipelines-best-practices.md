...
>[!NOTE]
>Используйте автоматическую синхронизацию с OneDrive (или любым другим репозиторием) только для PBIX-файлов на этапе разработки конвейеров развертывания. Не синхронизируйте PBIX-файлы в конвейерах развертывания и на тестовых и рабочих этапах. Это приведет к проблемам с развертыванием содержимого в конвейере.
...
![диаграмма советов и рекомендаций по конвейерам развертывания](media/deployment-pipelines-best-practices/deployment-pipelines-best-practices-diagram.png)
