...
При небольших изменениях, например при добавлении таблицы или вычисляемых мер, Power BI сохраняет исходные данные, а обновление оптимизировано для обновления только необходимых данных. Для критических изменений схемы или изменения соединения с источником данных требуется полное обновление.
...
* Список ограничений правил для наборов данных см. в разделе [Ограничения правил для наборов данных](deployment-pipelines-get-started.md#dataset-rule-limitations)
