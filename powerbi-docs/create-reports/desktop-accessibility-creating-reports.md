...
![Снимок экрана: отчет с примененными параметрами высокой контрастности в Windows.](media/desktop-accessibility/accessibility-05b.png)
...
![Снимок экрана: выбор темы с цветами с высокой контрастностью.](media/desktop-accessibility/accessibility-creating-reports-02.png)
