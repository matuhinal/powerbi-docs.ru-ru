...
![Снимок экрана холста отчета, показывающий, как использовать линии сетки и привязку к сетке в отчетах Power BI Desktop](media/desktop-gridlines-snap-to-grid/snap-to-grid_0.png)
...
![Снимок экрана холста отчета, показывающий, как включить линии сетки и привязку к сетке в отчетах Power BI Desktop](media/desktop-gridlines-snap-to-grid/snap-to-grid_1.png)
...
![Снимок экрана холста отчета, показывающий, как выровнять визуальные элементы с помощью линий сетки](media/desktop-gridlines-snap-to-grid/snap-to-grid_2.png)
...
![Снимок экрана: визуальный элемент с разделом "Линии сетки" на карте "Ось Y"](media/desktop-gridlines-snap-to-grid/snap-to-grid_9.png)
...
![Снимок экрана холста отчета, показывающий, как линии сетки и привязка к сетке могут обеспечить аккуратное выравнивание визуальных элементов в отчетах](media/desktop-gridlines-snap-to-grid/snap-to-grid_3.png)
...
![Снимок экрана холста отчета, показывающий, как управлять порядком расположения визуальных элементов в отчете от начала к концу](media/desktop-gridlines-snap-to-grid/snap-to-grid_4.png)
...
![Снимок экрана холста отчета, показывающий, как выровнять визуальные элементы множеством разных способов](media/desktop-gridlines-snap-to-grid/snap-to-grid_5.png)
...
![Снимок экрана холста отчета, показывающий, как с помощью кнопки "Выровнять" можно выровнять выбранный визуальный элемент по краю (или центру) холста](media/desktop-gridlines-snap-to-grid/snap-to-grid_6.png)
...
![Снимок экрана холста отчета, показывающий, как выровнять два визуальных элемента с помощью параметра "Выровнять по левому краю"](media/desktop-gridlines-snap-to-grid/snap-to-grid_7.png)
...
![Снимок экрана холста отчета, показывающий, как равномерно распределить визуальные элементы по холсту с помощью параметра "Распределить"](media/desktop-gridlines-snap-to-grid/snap-to-grid_8.png)
