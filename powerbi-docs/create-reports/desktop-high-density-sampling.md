...
![Снимок экрана: графики, показывающие данные выборки с высокой плотностью](media/desktop-high-density-sampling/high-density-sampling_01.png)
...
![Снимок экрана: выборка линий с высокой плотностью, где стрелки указывают на панель форматирования, элемент "Общие" и элемент "Выборка с высокой плотностью"](media/desktop-high-density-sampling/high-density-sampling_02.png)
