...
![Снимок экрана: точечная диаграмма, показывающая данные выборки с высокой плотностью](media/desktop-high-density-scatter-charts/high-density-scatter-charts_01.png)
...
* Если щелкнуть правой кнопкой мыши значение под элементом **Сведения**, а затем в открывшемся меню выбрать команду **Показать элементы без данных**, точечная диаграмма вернется к исходному алгоритму.
  ...
  ![Снимок экрана: меню "Визуализация", в котором отображается область "Сведения" с выбранным параметром "Показать элементы без данных"](media/desktop-high-density-scatter-charts/high-density-scatter-charts_02.png)
...
* Если использовать параметр **Линия отношения** на панели **Аналитика**, диаграмма вернется к исходному алгоритму.
  ...
  ![Снимок экрана: меню "Визуализация" с панелью "Аналитика" и параметром "Линия соотношения"](media/desktop-high-density-scatter-charts/high-density-scatter-charts_03.png)
...
![Снимок экрана: меню "Визуализация" с панелью "Форматирование", карточкой "Общие" и переключателем "Выборка с высокой плотностью"](media/desktop-high-density-scatter-charts/high-density-scatter-charts_04.png)
