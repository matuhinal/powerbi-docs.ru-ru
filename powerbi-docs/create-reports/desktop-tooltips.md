...
![Снимок экрана: настраиваемая подсказка для отчета.](media/desktop-tooltips/desktop-tooltips_06.png)
...
* Подсказки отчета не поддерживаются для визуальных элементов Power BI. 
