...
Обновленные данные загружаются каждый раз при запуске расписания. Имейте в виду, что базовые данные предоставляются USAFacts и могут обновляться не так часто, как предусмотрено обновление в расписании. Посетите [веб-сайт USAFacts](https://usafacts.org/visualizations/coronavirus-covid-19-spread-map/), чтобы узнать, когда базовые данные обновлялись в последний раз. 
