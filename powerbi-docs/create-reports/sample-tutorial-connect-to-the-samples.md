...
1. Переключитесь в [Представление данных](../connect-data/desktop-data-view.md), выбрав значок таблицы ![значок таблицы](media/sample-tutorial-connect-to-the-samples/power-bi-data-icon.png).
...
1. Переключитесь в [представление связей](../transform-model/desktop-relationship-view.md), выбрав следующий значок: ![значок представления связей](media/sample-tutorial-connect-to-the-samples/power-bi-desktop-relationship-icon.png).
