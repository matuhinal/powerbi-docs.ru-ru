...
* **Ссылка**
  ...
  * Ссылка на определенный столбец (включая преобразования, предусматривающие усечение, очистку (с июня 2017 г.) и изменение регистра)
* **Преобразования текста**
  ...
  * Ниже перечислены поддерживаемые **преобразования текста**, которые доступны начиная с выпуска **Power BI Desktop** за июнь 2017 г.
    
    * Длина

> [!NOTE]
> Все преобразования *текста* учитывают потенциальную необходимость преобразования в виде усечения значения столбца, очистки (с июня 2017 г.) или изменения регистра.
> 
> 
...
* **Преобразования даты**
  ...
  * Неделя года
  * Year (Год)
* Ниже перечислены дополнительные поддерживаемые **преобразования дат**, которые доступны начиная с выпуска **Power BI Desktop** за июнь 2017 г.
...
* **Преобразования времени**
  ...
  * Минута
  * Секунда
* Выше перечислены поддерживаемые **преобразования дат, времени и часового пояса**, которые доступны начиная с выпуска **Power BI Desktop** за июль 2017 г.
...
* Ниже перечислены поддерживаемые **преобразования чисел**, которые доступны начиная с выпуска **Power BI Desktop** за июль 2017 г.
  * Абсолютное значение
  * Арккосинус
  * Арксинус
  * Арктангенс
