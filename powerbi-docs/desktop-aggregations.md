...
### <a name="aggregation-tables-are-not-addressable"></a>Таблицы агрегирования не являются адресуемыми
...
Поэтому таблица **Sales Agg** должна быть скрыта. В противном случае диалоговое окно "Управление агрегатами" делает ее скрытой при нажатии кнопки "Применить".
