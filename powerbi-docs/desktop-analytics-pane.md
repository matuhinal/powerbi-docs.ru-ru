...
Панель **Аналитика** в **Power BI Desktop** позволяет добавлять динамические *строки ссылок* для визуальных элементов, чтобы сосредоточиться на важных трендах и сведениях. Панель **Аналитика** находится в области **Визуализации** приложения Power BI Desktop, начиная с версии от августа 2016 г. (2.37.4464.321 или более поздняя), как показано ниже.
...
## <a name="enable-forecasting-preview"></a>Включение прогнозирования (предварительная версия)
Кроме того, начиная с выпуска **Power BI Desktop** за сентябрь 2016 г. (версия 2.39.4526.362 и более поздние) с помощью панели **Аналитика** также можно выполнять *прогнозирование*. Эту функцию, доступную в предварительной версии, необходимо включить, последовательно выбрав элементы **Файл > Параметры и настройки > Параметры** и выбрав пункт **Предварительная версия функций** в левой области. Установите флажок **Forecasting** (Прогнозирование), чтобы включить эту функцию, как показано на следующем рисунке. Чтобы изменения вступили в силу, необходимо перезапустить **Power BI Desktop**.
