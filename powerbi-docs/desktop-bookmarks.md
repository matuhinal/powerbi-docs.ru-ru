---
title: "Использование закладок в Power BI (предварительная версия)"
...
### <a name="enable-the-bookmarks-preview"></a>Включение предварительной версии функции "Закладки"
Новая функция **Закладки** доступна начиная с выпуска **Power BI Desktop** за **октябрь 2017 г.** и для отчетов с поддержкой закладок в **службе Power BI**. Чтобы включить эту предварительную версию функции, выберите **Файл > Параметры и настройки > Параметры > Предварительная версия функций** и установите флажок рядом с пунктом **Закладки**. После этого изменения приложение Power BI Desktop необходимо перезапустить.
...
К предварительному выпуску функции **Закладки** применяется ряд ограничений и рекомендаций.
...
* Так как закладки доступны только в предварительной версии, этот компонент не доступен в [**Power BI Desktop для сервера отчетов**](report-server/quickstart-create-powerbi-report.md).
