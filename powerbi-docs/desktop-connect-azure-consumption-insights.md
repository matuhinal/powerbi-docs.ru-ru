...
* Пользователи с **Соглашением Enterprise** должны подключаться с помощью **соединителя Azure Consumption Insights**.

* Пользователи с **клиентским договором** должны подключаться с помощью **соединителя Управления затратами Azure**.
...
В этом разделе вы узнаете, как получить необходимые данные, выполнить миграцию из соединителя Azure Enterprise и найти сопоставление *столбцов со сведениями об использовании* в API **ACI** (Azure Consumption Insights).
...
Просмотрите видео [How to analyze spending in Power BI with Azure Consumption Insights](https://www.youtube.com/watch?v=QKBMXXrlpEk) (Анализ расходов в Power BI с помощью Azure Consumption Insights) об анализе данных о затратах в Power BI Desktop с помощью соединителя Azure Consumption Insights.
