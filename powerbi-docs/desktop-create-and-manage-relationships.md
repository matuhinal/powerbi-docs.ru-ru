...
Третий параметр — *Автоматическое определение новых связей после загрузки данных*. Он описан в разделе [Автообнаружение при загрузке](#autodetect-during-load), приведенном ранее в этой статье. 
