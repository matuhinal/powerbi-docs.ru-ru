...
| (&quot;ABC&quot;) | Отображает строку, заключенную в двойные кавычки (&quot; &quot;). Чтобы добавить строку в **формате** из кода, необходимо использовать **Chr(34)** и заключить текст в кавычки (34 —это код знака для кавычек (&quot;)). |
...
* [Заголовки на основе выражений в Power BI Desktop](desktop-conditional-format-visual-titles.md)
