...
Если щелкнуть **Еще...** в меню **Наиболее распространенные**, отобразится окно **Получить данные**. Вы также можете открыть окно **Получение данных** (и обойти меню **Самые распространенные**), напрямую нажав кнопку **Получить данные** **со значком**.
