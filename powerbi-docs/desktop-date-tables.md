...
Обратите внимание, что при создании собственной таблицы дат в **Power BI Desktop** иерархии не создаются автоматически, как при выборе другого варианта, когда они встраиваются в модель от вашего имени. Если вы позже отменить выбор таблицы дат (и больше не иметь таблицу дат, настроенной вручную), Power BI Desktop повторно автоматически создаются встроенные таблицы дат, для столбцов дат в таблице.
