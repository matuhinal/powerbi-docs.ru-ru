...
| Работа с неоднородными иерархиями |![](media/desktop-directquery-sap-bw/directquery-sap-bw_01.png) |
...
В следующей таблице перечислены ограничения бета-версии соединителя SAP BW.

| Ограничения | Описание |
| --- | --- |
| Без обновления |Кнопка "Обновить" отключена, а визуализации и метаданные не могут быть обновлены. |
