...
Предпочитаете смотреть, а не читать? Прежде всего [ознакомьтесь с нашим вводным видео](desktop-videos.md). Если вы хотите изучить видео с соответствующими демонстрационными данными, можно [загрузить этот пример книги Excel](https://go.microsoft.com/fwlink/?LinkID=521962).
...
> [!NOTE]
> Табличные данные, приводимые в этой статье, могут со временем изменяться. Поэтому действия, которые необходимо выполнить, могут отличаться от указанных ниже, и вам потребуется творчески подойти к настройке шагов или результатов. Дерзайте, ведь это делает процесс обучения увлекательным. 
