...
В обновлениях за этот месяц мы представили новые функции и улучшения, которые сделают отчеты еще эффективнее, а аналитические данные в них — содержательнее.
