...
1. Щелкните значок **Визуальный элемент Python** на панели **Визуализация**.
   
   ![](media/desktop-python-visuals/python-visuals-2.png)

1.  В появляющемся диалоговом окне **Включить визуальные элементы сценария** выберите **Включить**. 

    При добавлении визуального элемента Python в отчет служба **Power BI Desktop** выполняет следующие действия:
...
1. Затем перетащите поля **Age**, **Children**, **Fname**, **Gender**, **Pets**, **State** и **Weight** в раздел **Values**, где приводится надпись **Добавьте сюда поля с данными**. 
...
1. Теперь выбранные данные можно использовать для создания визуализации. 
    ...
    В результате редактор скриптов Python создает следующий код привязки.
