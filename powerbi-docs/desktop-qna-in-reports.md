...
> [!NOTE]
> Функция "Вопросы и ответы" доступна только при работе с моделью, содержащей **импортированные** данные, или с динамическим подключением к SQL Server Analysis Services (SSAS). Модели DirectQuery не поддерживаются.
>
