...
2. При добавлении в отчет визуального элемента R в **Power BI Desktop** выполняются перечисленные ниже действия:
   ...
   а) На холсте отчета появляется изображение заполнителя для визуального элемента R.
   
   б) Внизу центральной области открывается **редактор R-скриптов** .
