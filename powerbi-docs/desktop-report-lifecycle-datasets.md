...
Когда Анна создаст отчет (и создает набор данных, на котором он основан) и опубликует его в **службе Power BI**, он отобразится в рабочей области ее команды в службе Power BI. Если Анна сохраняет его в *новом интерфейсе рабочих областей*, то может задать разрешение на сборку, чтобы все пользователи в ее рабочей области и вне ее могли просматривать и использовать этот отчет.
