...
Дополнительные сведения о рабочих областях см. в статье [Рабочие области приложений](service-create-workspaces.md).
...
Чтобы установить подключение к опубликованному отчету и создать отчет на основе опубликованного набора данных, выберите **получить данные** из **Главная** ленты в **Power BI Desktop** , выберите **Power BI** из левой области, а затем выберите **наборов данных Power BI**.
