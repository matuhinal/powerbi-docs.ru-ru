...
![Нестандартные темы для отчетов](media/desktop-report-themes/report-themes_2.png)
...
* **dataColors** — это список шестнадцатеричных цветовых кодов для данных визуальных элементов Power BI Desktop. Список может содержать любое необходимое количество цветов.
