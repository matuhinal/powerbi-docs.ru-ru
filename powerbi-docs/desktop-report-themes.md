...
Кроме того, можно настраивать и стандартизировать почти все элементы. Для настройки используется файл JSON, который можно изменять вручную в области **форматирования**. Цель — предоставить вам полный контроль над как выглядят и работают на более детальном уровне, отчеты.
