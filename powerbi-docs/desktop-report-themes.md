...
ms.locfileid: "69023394"
---
# <a name="use-report-themes-in-power-bi-desktop"></a>Использование тем отчетов в Power BI Desktop
С помощью функции **Тема отчета** требуемую цветовую схему можно применить ко всему отчету. Это могут быть корпоративные цвета, цвета времен года, наборы значков или другие цветовые схемы. При применении функции **Тема отчета** для всех визуальных элементов в отчете используются цвета из выбранной схемы. Для цветовых схем есть несколько исключений. Они описаны далее в этой статье.

![Темы отчетов](media/desktop-report-themes/report-themes_1.png)
...
Кроме того, можно настраивать и стандартизировать почти все элементы. Для настройки используется файл JSON, который можно изменять вручную в области **форматирования**. Цель — дать пользователю полный контроль над внешним видом отчета вплоть до мелочей.
...
![Импорт темы](media/desktop-report-themes/report-themes_3.png)
...
![Раскрывающийся список "Стиль"](media/desktop-report-themes/report-themes_7.png)
