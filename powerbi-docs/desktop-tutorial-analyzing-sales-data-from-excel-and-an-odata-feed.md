...
2. В диалоговом окне **Веб-канал OData** вставьте URL-адрес для веб-канала OData Northwind `https://services.odata.org/V3/Northwind/Northwind.svc/`. Нажмите кнопку **ОК**.
