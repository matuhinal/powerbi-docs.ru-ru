...
> [!NOTE]
> Убедитесь, что в этом поле вы поставили перед десятичным числом 0, например 0,50, а не просто ,50. В противном случае число не будет проверено и кнопка **ОК** будет неактивна.
> 
> 
