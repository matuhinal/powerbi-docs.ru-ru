---
title: "Внедрение содержимого Power BI в приложение для клиентов для US Government"
...
---
# <a name="embed-a-power-bi-dashboard-tile-or-report-into-your-application-for-us-government"></a>Внедрение панели мониторинга, плитки или отчета Power BI в приложение для US Government
...
В отличие от общедоступного облака, облако US Government имеет три раздела для разных категорий.
...
Для работы с этим руководством вам потребуется учетная запись **Power BI US Government**. Если у вас не настроена такая учетная запись, можно [зарегистрироваться для получения учетной записи Power BI для государственных организаций](../service-govus-signup.md).
...
Вы должны зарегистрировать приложение в Azure Active Directory, чтобы осуществлять вызовы REST API. Дополнительные сведения см. в статье [Регистрация приложения Azure AD для внедрения содержимого Power BI](register-app.md). Так как существует три раздела для разных категорий, в зависимости от того, в государственной организации какого типа вы находитесь, имеется три разных URL-адреса для регистрации приложения.
...
Перед выполнением вызовов в REST API Power BI в приложении потребуется получить **маркер доступа** из Azure AD. Дополнительные сведения см. в статье [Authenticate users and get an Azure AD access token for your Power BI app](get-azuread-access-token.md) (Проверка подлинности для пользователей и получение маркера доступа Azure AD для приложения Power BI). Так как существует три раздела для разных категорий, в зависимости от того, в государственной организации какого типа вы находитесь, имеется три разных URL-адреса для получения токена доступа для вашего приложения.
