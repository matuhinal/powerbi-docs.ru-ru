...
ms.locfileid: "56216224"
---
# <a name="tutorial-embed-a-power-bi-content-into-your-application-for-sovereign-clouds"></a>Руководство. Внедрение содержимого Power BI в приложение национального облака
...
Для работы с руководством вам потребуется учетная запись **Power BI**. Если вы еще на настроили учетную запись, то в зависимости от типа государственной организации или страны можно выбрать подходящее национальное облако. Вы можете зарегистрировать учетную запись в [Power BI для государственных организаций США](../service-govus-signup.md), [Power BI для облачных служб в Германии](https://powerbi.microsoft.com/power-bi-germany/?ru=https%3A%2F%2Fapp.powerbi.de%2F%3FnoSignUpCheck%3D1) или [Power BI для облачных служб в Китае](http://www.21vbluecloud.com/powerbi/).
