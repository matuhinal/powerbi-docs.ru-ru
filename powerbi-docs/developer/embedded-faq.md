...
### <a name="what-is-the-difference-between-the-a-skus-in-azure-and-em-skus-in-office-365"></a>В чем разница между номерами SKU A в Azure и SKU EM в Office 365?
...
Служба Power BI Embedded будет доступна в коммерческих облачных средах Azure в общедоступной версии.  Доступность в независимых облаках будет добавлена в будущем.
