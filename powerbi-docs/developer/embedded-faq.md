...
| Использование отчетов Power BI во внедренном приложении для вашей организации  | Нет | Да | Да |
| Использование отчетов Power BI во внедренном приложении для ваших клиентов | Да | Да | Да |
