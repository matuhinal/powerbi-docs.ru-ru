...
2. Разверните раздел **Дополнительно** и установите переключатель **Выделенная емкость** в положение "Вкл.". Выберите созданную емкость. Затем выберите **Сохранить** .
