...
Когда все будет готово к переносу в рабочую среду, рабочую область нужно будет включить в емкость. [Создайте емкость Power BI Embedded](azure-pbie-create-capacity.md) в Microsoft Azure для использования с приложениями.
