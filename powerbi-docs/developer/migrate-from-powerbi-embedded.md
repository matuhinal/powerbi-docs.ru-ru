---
title: "Как перенести содержимое коллекции рабочих областей Power BI Embedded в Power BI"
description: "Сведения о переносе содержимого из Power BI Embedded в службу Power BI и его внедрении в приложения с помощью расширенных функций."
services: powerbi
documentationcenter: 
author: guyinacube
manager: kfile
...
---
# <a name="how-to-migrate-power-bi-embedded-workspace-collection-content-to-power-bi"></a>Как перенести содержимое коллекции рабочих областей Power BI Embedded в Power BI
...
Недавно корпорация Майкрософт [объявила о выпуске Power BI Premium](https://powerbi.microsoft.com/blog/microsoft-accelerates-modern-bi-adoption-with-power-bi-premium/) — новой модели лицензирования на основе емкости, которая повышает возможности получения доступа к содержимому, а также его совместного использования и распространения. Это предложение также обеспечивает дополнительные возможности масштабирования и повышает производительность службы Power BI.
...
Вы можете использовать **инструмент переноса**, чтобы скопировать содержимое из Power BI Embedded в службу Power BI. Особенно если содержимого у вас много. Дополнительные сведения см. в статье [Инструмент переноса Power BI Embedded](migrate-tool.md).
...
Соответствующие фрагменты кода приведены в разделе [Фрагменты кода для переноса содержимого из Power BI Embedded](migrate-code-snippets.md).
...
2. Перестройте параметры проверки подлинности AuthN и AuthZ с помощью *главной* учетной записи приложения. Вы можете воспользоваться [токеном внедрения](https://msdn.microsoft.com/library/mt784614.aspx), чтобы позволить этому пользователю действовать от имени других пользователей.
...
* Приобретите необходимый размер емкости. Чтобы понять, что вам может понадобиться, вы можете ознакомиться с [техническим документом по планированию емкости для внедренной аналитики](https://aka.ms/pbiewhitepaper). Когда вы будете готовы к покупке, вы сможете осуществить ее в [Центре администрирования Office 365](https://portal.office.com/adminportal/home#/catalog).
  
  > [AZURE.INFORMATION] Сведения о том, как приобрести Power BI Premium, см. в разделе [Как купить Power BI Premium](../service-admin-premium-purchase.md).
  > 
  > 
...
[Фрагменты кода для переноса содержимого из Power BI Embedded](migrate-code-snippets.md)  
