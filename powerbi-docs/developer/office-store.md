---
title: Публикация визуальных элементов Power BI в AppSource
...
**AppSource** — это место, где можно найти приложения SaaS и надстройки для продуктов и служб Майкрософт. [AppSource](https://appsource.microsoft.com/marketplace/apps?product=power-bi-visuals) позволяет миллионам пользователей Office 365, Azure, Dynamics 365 и других продуктов находить решения, с помощью которых можно выполнять работу более эффективно, продуманно и презентабельно.
...
| Значок |Да |Добавьте логотип пользовательской визуализации. Он будет отображаться в онлайн-магазине. Допустимые форматы: PNG, JPG, JPEG или GIF. Изображение должно быть размером строго 300 × 300 пикселей (ширина × высота). **Важно!** Перед отправкой значка ознакомьтесь с этим [кратким руководством](https://docs.microsoft.com/office/dev/store/craft-effective-appsource-store-images). |
...
| Ссылка на страницу поддержки |Да |Укажите URL-адрес страницы, на которой пользователи визуализации смогут получить поддержку. Эта ссылка вводится как часть спецификации SellerDashboard и отображается для пользователей, когда они получают доступ к списку визуального элемента в AppSource. URL-адрес должен начинаться с https:// или http://. |
| ссылку на заявление о конфиденциальности; |Да |Укажите ссылку на заявление о конфиденциальности для пользователей визуализации. Эта ссылка вводится как часть спецификации SellerDashboard и отображается для пользователей, когда они получают доступ к списку визуального элемента в AppSource. Ссылка должна начинаться с https:// или http://. |
| Лицензионное соглашение |Да |Необходимо отправить файл лицензионного соглашения. Можно использовать собственное лицензионное соглашение или стандартное лицензионное соглашение для визуальных элементов Power BI в Магазине Office. Чтобы использовать стандартное лицензионное соглашение, в диалоговом окне отправки файла лицензионного соглашения на панели мониторинга продавца вставьте следующий URL-адрес: [https://visuals.azureedge.net/app-store/Power BI - Default Custom Visual EULA.pdf](https://visuals.azureedge.net/app-store/Power%20BI%20-%20Default%20Custom%20Visual%20EULA.pdf). |
...
В первую очередь вам нужно связаться по электронной почте с командой Power BI, которая отвечает за прием визуальных элементов Power BI. Заявку можно отправить по адресу [pbivizsubmit@microsoft.com](mailto:pbivizsubmit@microsoft.com).
...
5. Укажите необходимую информацию в разделе **Общие сведения**.
   ...
   * *Категория:* в качестве первой категории автоматически будет указано "Визуализация данных и бизнес-аналитика". Так обозначаются все визуальные элементы Power BI. Чтобы пользователи могли быстрее находить вашу визуализацию, можно указать две дополнительные категории.
...
[Получение *сертификации* для пользовательского визуального элемента](../developer/power-bi-custom-visuals-certified.md)
