...
Нет, это невозможно. Визуализация не может потерять статус сертифицированной после очередного обновления. Это обновление отклоняется.
...
Если вы работаете с визуализацией Power BI с функцией IAP, убедитесь, что она соответствует [рекомендациям](guidelines-powerbi-visuals.md).  
