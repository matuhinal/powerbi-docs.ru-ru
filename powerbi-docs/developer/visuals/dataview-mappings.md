...
По умолчанию для всех пользовательских визуальных элементов применяется верхний алгоритм сокращения данных, для которого в значении *count* задана 1000 точек данных. Это эквивалентно установке следующих свойств в файле *capabilities.json*:
