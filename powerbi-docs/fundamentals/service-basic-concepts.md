...
![Снимок главного экрана службы Power BI в браузере с пронумерованными областями, перечисленными ниже](media/service-basic-concepts/power-bi-home-screen.png)
...
![Снимок экрана: Power BI с примером рабочей области, где выбраны наборы данных](media/service-basic-concepts/power-bi-datasets.png)
...
* визуализации из этого одного набора данных можно отображать на нескольких разных панелях мониторинга.
  ...
  ![Схема, показывающая связи набора данных с отчетом и панелью мониторинга](media/service-basic-concepts/drawing2.png)
...
![Снимок экрана: Power BI с примером рабочей области, где выбраны отчеты](media/service-basic-concepts/power-bi-reports.png)
...
* может быть создан с использованием данных из одного набора Приложение Power BI Desktop позволяет объединить в один набор данных в отчете несколько источников данных, и этот отчет можно импортировать в Power BI.
  ...
  ![Схема, показывающая связи отчета с набором данных и панелью мониторинга](media/service-basic-concepts/drawing3new.png)
...
* может отображать визуализации, закрепленные с помощью других средств (например, Excel).
  ...
  ![Схема, показывающая связи панели мониторинга с набором данных и отчетом](media/service-basic-concepts/drawing1.png)
...
![Снимок экрана: служба Power BI в браузере с пронумерованными функциями, перечисленными ниже](media/service-basic-concepts/completenewest.png)
...
Используйте область навигации для просмотра и выбора рабочих областей и основных компонентов Power BI: панелей мониторинга, отчетов, книг и наборов данных.  
  ...
  ![Снимок экрана: служба Power BI с областью навигации](media/service-basic-concepts/power-bi-navigation.png)
...
* Чтобы развернуть или свернуть область навигации, используйте следующий значок: ![Снимок экрана: служба Power BI со значком области навигации](media/service-basic-concepts/expand-icon.png).
...
![Снимок экрана: служба Power BI с холстом панели мониторинга](media/service-basic-concepts/canvas.png)
...
![Снимок экрана: служба Power BI с полем вопроса для функции Вопросы и ответы](media/service-basic-concepts/power-bi-qna.png)
...
![Снимок экрана: служба Power BI со значком классификации данных](media/service-basic-concepts/power-bi-title.png)
...
![Снимок экрана: служба Power BI со средством запуска приложений Office](media/service-basic-concepts/power-bi-waffle.png)

### <a name="7-power-bi-home"></a>7. **Главная страница Power BI**
Выбрав **Power BI**, вы вернетесь на главную страницу Power BI.

   ![Снимок экрана: служба Power BI со значком для возврата на главную страницу Power BI](media/service-basic-concepts/version-new.png)
...
Эта область экрана содержит дополнительные параметры для взаимодействия с содержимым (в этом случае с панелью мониторинга).  Рядом с отображенными значками с метками есть меню **Дополнительные параметры (…)** . Если щелкнуть его, появятся команды для дублирования, печати, обновления панели мониторинга и выполнения других действий.
   ...
   ![Снимок экрана: служба Power BI с маркированными кнопками значков](media/service-basic-concepts/power-bi-labeled-icons.png)
