...
- Применение [сертификации данных](../collaborate-share/service-endorsement-overview.md) для повышения уровня использования достоверных и надежных данных.
