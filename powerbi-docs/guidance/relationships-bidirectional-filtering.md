...
![Схема, показывающая модель того, что связь между таблицами "Продукт" и "Продажи" теперь двунаправленная](media/relationships-bidirectional-filtering/sales-model-diagram-rows-bi-directional-filter.png)
