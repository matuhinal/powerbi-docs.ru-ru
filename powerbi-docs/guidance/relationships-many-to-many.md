...
- Если отсутствие идентификаторов недопустимо, установите свойство **Допускает значение NULL** для столбцов идентификаторов в значение TRUE. В этом случае при обнаружении отсутствующих значений обновление данных будет завершаться сбоем.
