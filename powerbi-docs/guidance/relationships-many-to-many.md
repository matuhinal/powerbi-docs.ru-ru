...
![Схема, показывающая модель с тремя таблицами Подробное описание приводится в следующем абзаце.](media/relationships-many-to-many/bank-account-customer-model-example.png)
...
![Схема, показывающая, что модель теперь содержит четыре таблицы Для связывания таблиц были добавлены связи "один ко многим".](media/relationships-many-to-many/bank-account-customer-model-related-tables-1.png)
...
![Схема, показывающая, что модель теперь отображает строки таблицы В следующем абзаце описываются строки каждой из четырех таблиц.](media/relationships-many-to-many/bank-account-customer-model-related-tables-2.png)
...
![Схема, показывающая два визуальных элемента отчета, которые находятся рядом друг с другом Описываются в следующем абзаце.](media/relationships-many-to-many/bank-account-customer-model-queried-1.png)
...
![Схема, показывающая, что модель была обновлена Теперь она фильтруется в обоих направлениях.](media/relationships-many-to-many/bank-account-customer-model-related-tables-3.png)

![Схема, показывающая те же два визуальных элемента отчета, которые находятся рядом друг с другом Первый визуальный элемент не изменился, а второй — изменился.](media/relationships-many-to-many/bank-account-customer-model-queried-2.png)
...
![Схема, показывающая модель с двумя таблицами: "Заказ" и "Выполнение".](media/relationships-many-to-many/order-fulfillment-model-example.png)
...
![Схема, показывающая, что модель теперь отображает строки таблицы В следующем абзаце описываются строки каждой из двух таблиц.](media/relationships-many-to-many/order-fulfillment-model-related-tables.png)
...
![Схема, показывающая визуальный элемент таблицы с тремя столбцами: "ИдЗаказа", "Количество" и "ВыполненноеКоличество".](media/relationships-many-to-many/order-fulfillment-model-queried.png)
...
![Схема, показывающая модель с шестью таблицами: "ПозицияЗаказа", "ДатаЗаказа", "Заказ", "Выполнение", "Товар" и "ДатаВыполнения".](media/relationships-many-to-many/order-fulfillment-model-improved.png)
...
- Все связи имеют кратность "один ко многим" и являются _обычными_. Проблемы с целостностью данных не скрываются. Дополнительные сведения см. в разделе [Вычисление связей](../transform-model/desktop-relationships-understand.md#relationship-evaluation) из статьи "Создание связей модели в Power BI Desktop".
...
![Схема, показывающая модель с четырьмя таблицами: "Дата", "Продажи", "Товар" и "Цель".](media/relationships-many-to-many/sales-targets-model-example.png)
...
![Схема, показывающая таблицу "Цель" с тремя столбцами: "ЦелевойГод", "Категория" и "ЦелевоеКоличество".](media/relationships-many-to-many/sales-targets-model-target-rows.png)
...
![Схема, показывающая матричный визуальный элемент, где для 2020 года отображается целевое количество 270](media/relationships-many-to-many/sales-targets-model-matrix-blank-months-bad.png)
...
![Схема: матричный визуальный элемент, где для 2020 года отображается целевое количество 270 с пустыми ежемесячными значениями.](media/relationships-many-to-many/sales-targets-model-matrix-blank-months-good.png)
...
![Схема, показывающая модель таблиц "Цель" и "Продукт" Они связаны связью "многие ко многим".](media/relationships-many-to-many/sales-targets-model-relate-non-date.png)

Теперь давайте посмотрим на строки таблиц.

![Схема, показывающая модель с двумя таблицами: "Цель" и "Товар". Два столбца "Категория" связаны связью "многие ко многим".](media/relationships-many-to-many/sales-targets-model-relate-non-date-tables.png)
...
![Схема, показывающая визуальный элемент таблицы с двумя столбцами: "Категория" и "ЦелевоеКоличество". Значение для аксессуаров равно 60, для одежды — 40, а сумма — 100.](media/relationships-many-to-many/sales-targets-model-visual-category-targets.png)
...
![Схема, показывающая визуальный элемент таблицы с двумя столбцами: "Цвет" и "ЦелевоеКоличество". Значение для синего цвета равно 100, для зеленого — 40, а сумма — 100.](media/relationships-many-to-many/sales-targets-model-visual-color-targets-bad.png)
...
![Схема, показывающая визуальный элемент таблицы с двумя столбцами: "Цвет" и "ЦелевоеКоличество". значение для синего цвета пусто, для зеленого пусто, а сумма равна 100.](media/relationships-many-to-many/sales-targets-model-visual-color-targets-good.png)

Итоговая схема модели выглядит следующим образом:

![Схема, показывающая модель, в которой таблицы "Дата" и "Цель" имеют связь "один к многим"](media/relationships-many-to-many/sales-targets-model-example-final.png)
