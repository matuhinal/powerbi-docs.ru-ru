...
- Все связи имеют кратность "один ко многим" и являются _сильными_. Проблемы с целостностью данных не скрываются. Дополнительные сведения см. в разделе [Вычисление связей](../desktop-relationships-understand.md#relationship-evaluation) из статьи "Создание связей модели в Power BI Desktop".
