...
![Схема, показывающая, что модель теперь отображает строки таблицы Подробное описание строк приводится в следующем абзаце.](media/relationships-many-to-many/bank-account-customer-model-related-tables-2.png)
...
![Схема, показывающая, что модель теперь отображает строки таблицы Подробное описание строк приводится в следующем абзаце.](media/relationships-many-to-many/order-fulfillment-model-related-tables.png)
...
![Схема, показывающая матричный визуальный элемент, где для 2020 года отображается целевое количество 270](media/relationships-many-to-many/sales-targets-model-matrix-blank-months-good.png)
