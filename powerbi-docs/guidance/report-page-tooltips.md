...
ms.locfileid: "74834731"
---
# <a name="extending-visuals-with-report-page-tooltips"></a>Добавление подсказок в виде страниц отчета в визуальные элементы
...
Вы можете настроить отображение подсказок страниц для заголовков визуальных элементов. В подсказку страницы можно добавить содержимое справки с помощью текстовых полей с форматированием. Кроме того, можно добавить изображения и фигуры.
...
В приведенном ниже примере показано, что происходит, когда пользователь отчета наводит указатель мыши на значок заголовка визуального элемента.
...
Отобразилась подсказка страницы. В ней приводится форматированный текст, описывающий меры, которые отображаются в визуальном элементе. Подсказка также содержит фигуру (линию).
