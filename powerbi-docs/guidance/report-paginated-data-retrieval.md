...
Эта статья предназначена для разработчиков [отчетов Power BI с разбивкой на страницы](../paginated-reports-report-builder-power-bi.md). В ней приведены рекомендации по проектированию эффективного получения данных.
...
- [Поддерживаемые источники данных для отчетов с разбивкой на страницы Power BI](../paginated-reports-data-sources.md)
