...
| Содержимое | Описание | Формат  | Длина      |
|--------------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|---------|-------------|
|[Онлайн-курс: разработка в Power BI за один день](developer-online-course.md)|Видеокурс, который предоставит разработчикам приложений технические знания, необходимые для внедрения содержимого Power BI. Видеоролики рекомендуется смотреть в той последовательности, в которой они записаны, начиная с видео 1 и заканчивая видео 20.|Список воспроизведения YouTube и комплект для самостоятельного изучения|3 ч 20 мин|
