...
Когда будете готовы приступить к первому занятию, откройте файл **&lt;CourseFolder&gt;\PowerBIPRIAD\Lab01A\PowerBIPRIAD_Lab01A.pdf**. В этом документе описывается, как войти в службу Power BI, передать набор данных, а затем установить [построитель отчетов Power BI](https://aka.ms/pbireportbuilder).
