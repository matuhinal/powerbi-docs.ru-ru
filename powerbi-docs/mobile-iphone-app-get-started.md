...
![Панель мониторинга мобильного приложения Power BI для устройств iPhone](media/mobile-iphone-app-get-started/power-bi-mobile-get-started-dash.png)
...
[Скачать приложение для iOS](http://go.microsoft.com/fwlink/?LinkId=522062 "Скачайте приложение для iPhone или iPod Touch") из Apple App Store.

> [!NOTE]
> Power BI можно запускать в приложении для iOS на iPhone 5 и более новых моделях устройства, работающих под управлением iOS 9.0 и более поздних версий. Также можно пользоваться устройствами iPod Touch с iOS 9.0 или более поздней версии.
> 
> 
...
1. Откройте приложение Power BI на устройстве iPhone.
...
3. Откройте папку отчетов по розничным продажам или отчетов по сбыту и изучите ключевые показатели эффективности и мобильные отчеты.
   ...
   ![Примеры для Reporting Services в мобильном приложении Power BI](media/mobile-iphone-app-get-started/power-bi-iphone-ssrs-samples.png)
...
> [!NOTE]
> Если вы используете мобильное приложение Power BI на iPhone и в вашей организации настроены возможности Microsoft Intune MAM, то фоновое обновление данных будет отключено. Power BI обновит данные из службы Power BI в Интернете при следующем входе в приложение.
> 
> 
...
Ниже перечислены дополнительные возможности, доступные при работе с панелями мониторинга и отчетами в приложении Power BI для устройств iPad, а также при работе с отчетами и ключевыми показателями эффективности на веб-портале сервера отчетов Power BI и служб Reporting Services.
...
* Просмотр плиток Power BI на часах [Apple Watch](mobile-apple-watch.md).
* Установка [оповещений](mobile-set-data-alerts-in-the-mobile-apps.md) для данных.
* Предоставление доступа к [информационным панелям Power BI](mobile-share-dashboard-from-the-mobile-apps.md).
* [Добавление заметок и совместное использование](mobile-annotate-and-share-a-tile-from-the-mobile-apps.md) плиток, отчетов и визуализаций.
* Открытие панели мониторинга или отчета с помощью [сканирования QR-кода Power BI](mobile-apps-qr-code.md).
* [Создание плиток изображений](mobile-iphone-app-get-started.md) в приложении для iPhone.
