...
description: "Сведения о том, как в мобильных приложениях и службе Power BI настраивать оповещения о том, что данные на информационных панелях превышают заданные ограничения."
services: powerbi
documentationcenter: 
author: maggiesMSFT
manager: kfile
...
В мобильном приложении Power BI и в службе Power BI можно настроить оповещения, уведомляющие о том, что данные на информационных панелях выходят за установленные пределы. Оповещения используются с плитками, которые сдержат отдельные элементы (например, карточки и датчики), но не данные потоковой передачи. Оповещения о данных можно настраивать на мобильном устройстве и просматривать в службе Power BI, и наоборот. Видеть настраиваемые оповещения о данных можете только вы, даже если панель мониторинга или моментальный снимок плитки находятся в общем доступе.
