...
> [!NOTE]
> Предлагаемые вопросы будут отображаться для всех экземпляров визуального элемента "Вопросы и ответы". Невозможно создать отдельный набор предложений для каждой визуализации "Вопросы и ответы".
> 
> 
