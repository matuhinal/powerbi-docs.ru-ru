...
Да. Вы не сможете отправить отчеты в рабочую область, не имея лицензии Pro. Мы рекомендуем вам загрузить и использовать построитель отчетов Power BI даже без лицензии Pro, но не удается опубликовать отчеты с разбивкой на страницы, созданные без него. 
...
### <a name="the-documentation-says-power-bi-report-builder-is-the-preferred-authoring-tool-can-i-create-paginated-reports-in-sql-server-data-tools-for-power-bi"></a>В документации сказано, что построитель отчетов Power BI — предпочтительное средство разработки. Но могу ли я создавать отчеты с разбивкой на страницы в SQL Server Data Tools для Power BI?
...
Недавно мы выпустили построитель отчетов Power BI как основное средство разработки отчетов с разбиением на страницы в службе Power BI. Установка [Power BI построителе из центра загрузки Майкрософт](https://go.microsoft.com/fwlink/?linkid=2086513).
...
Сейчас это невозможно. Мы добавили поддержку для открытия отчетов и их публикации непосредственно к службе из построителя отчетов Power BI до общедоступной версии, как это можно сделать с помощью Power BI Desktop.
...
Мы поддерживаем следующий источник данных — 

- Наборы данных Power BI Premium
- Службы Azure Analysis Services (с помощью единого входа (SSO))
- База данных SQL Azure
- SQL Server *
- Службы SQL Server Analysis Services (SSAS) табличных DAX и многомерных моделей (многомерные Выражения) * 
- Oracle * 
- Teradata * 

* требуется локальный шлюз.
...
Мы поддерживаем единого входа для источников данных служб Azure Analysis Services и Power BI Premium.  Для других источников данных необходимо в данный момент для хранения имени пользователя и пароль с источником данных на портале или шлюза.  
...
Да, мы теперь поддерживают наборы данных Power BI Premium в качестве источников данных для отчетов с разбиением на страницы.
...
Да, печать доступна для отчетов с разбиением на страницы, включая возможности новых и улучшенных функций предварительного просмотра печати. 
...
Да, для развертывания с помощью приложения из рабочих областей v1 и v2 поддерживаются отчеты с разбивкой на страницы. 
...
- [Установка построителя отчетов BI Power из центра загрузки Майкрософт](https://go.microsoft.com/fwlink/?linkid=2086513)
