---
title: Руководство. Создание отчета с разбивкой на страницы и отправка отчета в службу Power BI | Документация Майкрософт
...
ms.locfileid: "52452831"
---
# <a name="tutorial-create-a-paginated-report-and-upload-it-to-the-power-bi-service"></a>Руководство. Создание отчета с разбивкой на страницы и отправка отчета в службу Power BI
...
> * создание матрицы в построителе отчетов с помощью мастера;
...
- Установите [построитель отчетов из Центра загрузки Майкрософт](http://go.microsoft.com/fwlink/?LinkID=734968). 
...
- Рабочая область приложения в службе с [емкостью Power BI Premium](service-premium.md). Такие рабочие области отмечены значком в виде бриллианта ![значок в виде бриллианта для емкости Premium](media/paginated-reports-quickstart-aw/premium-diamond.png) рядом с именем рабочей области.

## <a name="create-the-matrix-with-a-wizard"></a>Создание матрицы с помощью мастера
  
1.  Откройте на локальном компьютере построитель отчетов.  
