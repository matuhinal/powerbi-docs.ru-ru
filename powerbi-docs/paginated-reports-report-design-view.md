...
Представлении конструктора отчетов в построителе отчетов Power BI — это пространство проектирования для создания отчетов с разбиением на страницы, которые можно опубликовать в службе Power BI. В центре построителя отчетов размещается область конструктора, и ее окружают лента и панели. Именно в области конструктора вы будете добавлять и упорядочивать элементы отчета. В этой статье приводятся сведения о панелях, которые позволяют добавлять, выбирать и упорядочивать ресурсы отчета, а также изменять свойства элементов отчета.  
