...
![Свойства набора данных параметра в построителе отчетов](media/report-builder-parameters/report-builder-parameter-dataset.png "Свойства набора данных параметра построителя отчетов")
