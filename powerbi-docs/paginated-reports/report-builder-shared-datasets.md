...
Набор данных необязательно должен находиться в рабочей области в емкости Premium и быть членом этой рабочей области. Вам нужно просто [разрешение на сборку](../connect-data/service-datasets-build-permissions.md) для набора данных. Для публикации отчета с разбивкой на страницы требуется лицензия Power BI Pro. Кроме того, для рабочей области в емкости Premium требуется по меньшей мере роль участника.
...
1. Убедитесь, что в отчете есть таблица, содержащая все необходимые данные, которые должны присутствовать в отчете с разбивкой на страницы. Таблица должна удовлетворять следующим двум требованиям.
    ...
    - Для числовых полей необходимо использовать *предопределенные меры*. Рядом с ними есть символ калькулятора. Прочитайте о [создании мер](../transform-model/desktop-measures.md). 
