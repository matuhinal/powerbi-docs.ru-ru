...
Но вам не обязательно использовать именно этот набор. Нажав кнопку с многоточием (...) в нижней части экрана, можно открыть другой источник визуальных элементов для отчета: *Визуальные элементы Power BI*.
