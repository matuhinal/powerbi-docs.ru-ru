...
2. Выберите столбец в представлении данных. 
...
2. В представлении отчетов создайте таблицу или матрицу со столбцом, который будет отформатирован как текст ссылки.
...
4. Разверните **Условное форматирование**, убедившись в том, что имя в поле является столбцом, который нужно использовать в качестве текста ссылки. Щелкните **значок URL-адреса**и переключите его на **Вкл.**
