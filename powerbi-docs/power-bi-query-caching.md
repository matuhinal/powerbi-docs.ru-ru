...
- **По умолчанию для емкости**. Набор данных наследует значение параметра от емкости Premium. Параметр по умолчанию для емкости контролируется администратором емкости Power BI Premium.
