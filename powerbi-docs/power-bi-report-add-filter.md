...
* В режиме чтения можно взаимодействовать с уже существующими в отчете фильтрами отчетов, детализаций, страниц и визуальных элементов, но добавлять новые фильтры запрещено. Изменения, вносимые на панели "Фильтры", сохраняются вместе с отчетом, даже если он открыт в мобильном приложении.  
