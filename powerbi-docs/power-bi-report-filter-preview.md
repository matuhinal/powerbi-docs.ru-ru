...
Вы может включить новые функции в Power BI Desktop. Затем вы можете изменить фильтры там же или в службе Power BI (https://app.powerbi.com). Так как эти функции предоставляются в предварительной версии, сначала необходимо включить их в Power BI Desktop. 

### <a name="turn-on-new-filters-for-all-new-reports"></a>Включение новых функций фильтров для всех новых отчетов

1. Выберите **Файл** > **Параметры и настройки** > **Параметры** > **Предварительная версия функций** и установите флажок **Новые функции фильтров**. 
...
1. В существующем отчете выберите **Файл** > **Параметры и настройки** > **Параметры**.
