...
Чтобы снизить задержку в сети, используйте службу [Azure ExpressRoute](https://azure.microsoft.com/en-us/services/expressroute/), которая позволяет создавать быстрые, более надежные сетевые подключения между клиентами и центрами обработки данных Azure. 
