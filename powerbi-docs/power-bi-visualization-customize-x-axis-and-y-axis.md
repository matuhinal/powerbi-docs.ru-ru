...
6. Перетащите параметр **Gross Margin Last Year %** (% валовой прибыли за прошлый год) из области **Значения столбцов** в область **Значения строк**. Теперь у нас есть гистограмма с накоплением, созданная ранее, ***и*** график.  (При необходимости воспользуйтесь инструкциями выше, чтобы отформатировать цвет и размер шрифта оси.)
