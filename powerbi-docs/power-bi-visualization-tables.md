...
description: "Советы по работе с визуализациями таблиц в отчетах и на информационных панелях Power BI, включая способы изменения ширины столбцов."
services: powerbi
documentationcenter: 
author: mihart
manager: kfile
...
Для выполнения этой процедуры войдите в Power BI и выберите **Получить данные > Примеры > Анализ розничной торговли — пример**. Мы создадим показанную выше таблицу для отображения общей суммы продаж по категории изделия.

1. На странице **Моя рабочая область** перейдите на вкладку "Наборы данных" и прокрутите экран вниз до только что добавленного набора данных "Анализ розничной торговли — пример".  Щелкните значок **Создать отчет**.
