...
| Команда получения данных используется для подключения к Базе данных SQL Azure, хранилищу данных SQL Azure, Azure HDInsight Spark и запроса данных оттуда. |Да (каждый час) |Нет |Нет |
