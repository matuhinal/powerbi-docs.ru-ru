...
Если набор данных использует источник данных, к которому Power BI не может обратиться через прямое сетевое соединение, прежде чем включить расписание обновления или выполнить обновление данных по запросу, нужно настроить подключения шлюза для этого набора данных. Дополнительные сведения о шлюзах данных и их работе см. в статье [Что такое локальные шлюзы данных?](service-gateway-getting-started.md).
