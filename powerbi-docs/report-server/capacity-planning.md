...
![Схема, показывающая связи между Сервером отчетов Power BI, Active Directory и связанными базами данных](media/capacity-planning/report-server-topology.png)
