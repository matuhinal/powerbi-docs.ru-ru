...
![Снимок экрана: веб-портал Сервера отчетов Power BI.](media/get-started/power-bi-report-server-overview.png)
...
![Фото: ноутбук, на котором отображается веб-портал Сервера отчетов Power BI.](media/get-started/web-portal.png)
