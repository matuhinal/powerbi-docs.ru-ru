...
ms.locfileid: "66187318"
---
# <a name="whats-new-in-power-bi-report-server"></a>Новые возможности сервера отчетов Power BI

Узнайте о новинках в сервер отчетов Power BI и Power BI Desktop, оптимизированного для сервера отчетов Power BI. В этой статье приводятся сведения об основных функциях. Материалы обновляются по мере выпуска новых элементов.
...
## <a name="may-2019-power-bi-desktop-for-power-bi-report-server"></a>Мая 2019 г.: Power BI Desktop для сервера отчетов Power BI

См. в разделе [сервера отчетов Power BI мая 2019](https://powerbi.microsoft.com/blog/power-bi-report-server-update-may-2019/) записи блога, подробные сведения о всех новых функций.

Ниже приведены некоторые ключевые элементы выпуска.

### <a name="performance-analyzer"></a>Анализатор производительности 

Если отчет выполняется дольше, чем ожидалось, попробуйте Performance Analyzer в Power BI Desktop. При запуске, он создает файл журнала с информацией о каждое действие, что вы приняли в отчете. Дополнительные сведения о [Performance Analyzer](../desktop-performance-analyzer.md).

### <a name="new-modeling-view"></a>Модели представления

В новое представление моделирования в Power BI Desktop можно просматривать и работать с сложные наборы данных, которые содержат большое количество таблиц. Основные особенности включают несколько макеты схем и массового редактирования столбцов, мер и таблиц. Дополнительные сведения о [всеобъемлющую](../desktop-modeling-view.md).

### <a name="accessible-visual-interaction"></a>Доступны взаимодействие визуальных элементов

Вы можете теперь точек доступа данных на многие из встроенных визуальных элементов, с помощью клавиатуры. Дополнительные сведения о [специальных возможностей в отчетах Power BI](../desktop-accessibility.md).

### <a name="conditional-formatting-titles-and-web-url-actions"></a>Условное форматирование заголовков и URL-адрес веб-действий

Отчеты Power BI, являются интерактивными. Смысл заголовков в отчете будет динамической, чтобы отразить текущее состояние отчета. Можно использовать одинаковое форматирование привязанного к выражению сделать динамической URL-адреса вашей кнопки, фигур и изображений. Дополнительные сведения о [основано на выражении заголовки](../desktop-conditional-format-visual-titles.md).

### <a name="cross-highlight-by-axis-labels"></a>Перекрестное выделение с подписями оси

Выберите метки оси категорий в визуальный элемент для перекрестного выделения других элементов на странице, так же, как следует выбрать точки данных в визуальном элементе. Дополнительные сведения о [перекрестное выделение](../power-bi-reports-filters-and-highlighting.md#ad-hoc-highlighting).

### <a name="all-the-new-features"></a>Все новые возможности
...
- Перенос по словам на заголовки 
- По умолчанию visual взаимодействие обновления для ¬ кросс фильтр
- Скругленных углов для видимых границ 
- Один выберите срез  
- Поддержка тепловой карты Bing maps  
- Перекрестное выделение с подписями оси  
- Подсказка форматирование по умолчанию  
- Статические web URL-адрес поддержки для кнопок, фигур и изображений  
- Параметры выравнивания страницы   
- Усовершенствования области выбора  
- Доступны взаимодействие визуальных элементов  
- Условное форматирование для заголовков визуальных элементов  
- Условное форматирование для веб-действия URL-адреса для кнопок, фигур и изображений
- Панель анализатор производительности
- Таблицы и матрицы с помощью клавиатуры
- Метка позиции строки данных управления
- Ключевой показатель Эффективности visual индикатор размера текста

### <a name="analytics"></a>Аналитика

- Отображение дат теперь в виде иерархии в общем доступе  

### <a name="modeling"></a>Моделирование

- Модели представления, которые теперь доступны всем желающим
- Новые функции DAX
- Обновление до функция ALLSELECTED DAX
- Отключение таблиц автоматически даты для новых отчетов

## <a name="may-2019-power-bi-report-server"></a>Мая 2019 г.: Сервер отчетов Power BI

### <a name="support-for-trusted-visuals"></a>Поддержка надежных визуальных элементов

Мы добавили поддержку доверенного визуальных элементов на сервере отчетов Power BI. В настоящее время мы поддерживаем Mapbox и PowerOn визуальных элементов. Visio, PowerApps и ESRI не поддерживаются в этом выпуске.)

### <a name="improved-security-features"></a>Улучшенные средства безопасности

**RestrictedResourceMimeTypeForUpload**, которых администраторы можно использовать для указания разделенный запятыми список типов запрещенное mime, например text/html.
