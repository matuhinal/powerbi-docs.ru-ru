...
**SupportedHyperlinkSchemes**. Задает разделенный запятыми список схем URI, которые можно определять для отображаемых действий с гиперссылками (Hyperlink), или значение "&ast;" для включения всех схем гиперссылок. Например, если указать "http, https", будут разрешены гиперссылки на "https://www. contoso.com", но удаляет гиперссылки на "mailto:bill@contoso.com" или "javascript:window.open(‘ www.contoso.com’, ‘_blank’)". Значение по умолчанию: "&ast;".
