...
В этом учебнике используется служба Power BI и пакет содержимого для примера "Управление персоналом". Так как возможности отчетов очень похожи, вы также можете использовать Power BI Desktop и пример PBIX-файла. 
