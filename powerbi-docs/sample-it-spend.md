...
В этом учебнике используется служба Power BI и пакет содержимого для примера "Анализ расходов ИТ-отдела". Так как возможности отчетов очень похожи, вы также можете использовать Power BI Desktop и пример PBIX-файла.
