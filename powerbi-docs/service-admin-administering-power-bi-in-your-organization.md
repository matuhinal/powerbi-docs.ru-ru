...
| --- | --- |
| Портал администрирования Power BI |<ul><li>Запрет доступа пользователей к Power BI<br><li>Приобретение и применение емкости Premium<br><li>Обеспечение качества обслуживания<br><li>Управление классификацией бизнес-данных<br><li>Помощь в применении политик публикации и совместного использования содержимого<br><li>Управление рабочими областями<br><li>Публикация настраиваемых визуальных элементов<br><li>Проверка кодов, используемых для внедрения Power BI в другие приложения<br><li>Устранение неполадок с доступом к данным и решение других проблем</ul>|
| Центр администрирования Office 365 |<ul><li>Управление регистрацией пользователей<br><li>Приобретение и назначение лицензий Pro</ul>|
| Центр безопасности и соответствия требованиям Office 365 |<ul><li>Просмотр результатов аудита событий и управление им</ul>|
| Azure Active Directory (AAD) на портале Azure |<ul><li>Настройка условного доступа к ресурсам Power BI через AAD<br><li>Подготовка емкости Power BI Embedded</ul>|
| Командлеты PowerShell |<ul><li>Управление рабочими областями и другими аспектами Power BI с помощью скриптов</ul>|
| Административные API-интерфейсы |<ul><li>Создание собственных инструментов администрирования для упрощения работы администратора Power BI. Например, в Power BI Desktop эти API-интерфейсы могут использоваться для создания отчетов на основе данных об администрировании</ul>|

## <a name="next-steps"></a>Дальнейшие действия

Мы надеемся, что эта статья помогла вам получить общее представление о работе администраторов Power BI и связанных с ней ролях, задачах и средствах. Следующие две статьи помогут глубже разобраться в этой теме.
