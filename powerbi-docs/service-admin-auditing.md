...
Сведения о получении лицензий для Power BI Pro и назначении их пользователям в организации см. в разделе [Приобретение Power BI Pro](service-admin-purchasing-power-bi-pro.md).

Сведения о том, как запретить пользователям бесплатных лицензий регистрироваться в этом средстве, см. в разделе [Включение и отключение индивидуальной регистрации пользователей в каталоге Azure Active Directory](service-admin-service-free-in-your-organization.md#enable-or-disable-individual-user-sign-up-in-azure-active-directory).
...
В следующей таблице приведены сведения о том, какие события можно увидеть.

| **Событие** | **Описание** | **Дополнительные сведения** |
| --- | --- | --- |
| Скачанный отчет Power BI |Это действие регистрируется каждый раз при скачивании отчета |Имя отчета, имя набора данных |
| Создание отчета |Это действие регистрируется каждый раз при создании отчета. |Имя отчета, имя набора данных |
| Изменение отчета |Это действие регистрируется при каждом изменении отчета. |Имя отчета, имя набора данных |
...
| Обновление приложения Power BI |Это действие регистрируется при каждом обновлении Power BI |Имя приложения, разрешения, имя рабочей области |
| Начало работы в расширенной пробной версии Power BI |Это действие регистрируется каждый раз при принятии пользователем расширенной пробной версии, которая будет действовать до 31 мая 2018 года | |
