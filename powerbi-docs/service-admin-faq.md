...
1. Присоединитесь к клиенту, выполнив регистрацию в Power BI с использованием домена электронной почты, совпадающего с доменом клиента, которым вы хотите управлять. Например, если корпорация Майкрософт создала клиент contoso.com, вы присоединяетесь к нему, используя адрес электронной почты, который заканчивается символами @contoso.com.

1. Запросите административный контроль, подтвердив владение доменом: после присоединения к клиенту вы можете повысить свой уровень до роли *глобального администратора*, подтвердив владение доменом. Чтобы сделать это, выполните действия, описанные в [документации к Office 365](/office365/admin/misc/become-the-admin).
