...
* **Включено для всей организации.** Все в вашей организации могут использовать эту функцию.

    ![Включено для всех пользователей](media/service-admin-portal/powerbi-admin-tenant-settings-enabled.png)

* **Включено для части организации.** Только часть пользователей или определенные группы в вашей организации могут использовать эту функцию.
