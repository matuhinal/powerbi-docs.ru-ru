...
### <a name="enable-workloads-in-the-power-bi-admin-portal"></a>Включение рабочих нагрузок на портале администрирования Power BI

Чтобы включить рабочие нагрузки, выполните следующие действия.
