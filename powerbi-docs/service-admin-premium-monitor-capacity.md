...
В приложение регулярно добавляются новые возможности и функции. Убедитесь, что вы используете последнюю версию. Если у вас установлена предыдущая версия приложения, лучше всего удалить ее, а затем нажать клавиши CTRL+F5, чтобы выполнить обновление. 
...
Теперь, когда вы установили приложение, вы можете увидеть метрики емкости своей организации. Приложение предоставляет сводные метрики на панели мониторинга и отчеты подробные метрики.
...
#### <a name="ai-summary"></a>Сводка искусственного Интеллекта

| Метрика | Описание |
| --- | --- |
| Общее количество обновлений | Общее количество обновлений за последние семь дней. |
| Надежность обновления (%) | Количество успешных обновлений, разделенное на общее количество обновлений, за последние семь дней. |
| Max ЦП (%)| Максимальное использование ЦП AI рабочей нагрузки за последние семь дней. |
| Максимальная память (ГБ) | Максимальное потребление памяти от искусственного Интеллекта рабочей нагрузки за последние семь дней.|
| Обновляет максимальное время ожидания (мс) | Максимальное количество времени до начала обновления. |
| Обновляет среднее время ожидания (мс)| Среднее время перед началом обновления. |
| Обновляет Максимальная длительность (мс) | Максимальное количество времени для завершения обновления. |
| Средняя длительность обновления (мс)| Среднее время, необходимое для обновления. |
| | |
...
[**AI** ](#ai) -предоставляет подробные метрики на работоспособность функций искусственного Интеллекта, используемых в доступные емкости.
...
| **Раздел отчета** | **Метрики** |
| --- | --- |
| Общие сведения об использовании | Общее число: Число функций искусственного Интеллекта в рабочей области или потока данных. <br> Надежность. Процент обновлений, которые завершены.<br> Средн. Время ожидания: Средняя задержка между запланированное время и в начале обновления, в миллисекундах.<br> Максимальное время ожидания: Максимальное время ожидания в миллисекундах.<br> Средн. Длительность: Средняя длительность обновления, в миллисекундах.<br> Максимальная длительность: Длительность обновления продолжительные, в миллисекундах.<br> Размер входных данных среднее: Среднее значение входной размер в байтах для функции искусственного Интеллекта, выполняемая обновления потока данных.<br> Размер выходного среднее: Среднее значение выходной размер в байтах для функции искусственного Интеллекта, выполняемая обновления потока данных. |
| 5 основных функций искусственного Интеллекта по средней длительности | Пять функций с наибольшим средним обновить интервал времени в миллисекундах. |
| 5 основных функций искусственного Интеллекта Средний размер входных данных | Пять функций с наибольшим среднего значения данных входной размер в байтах. |
| Почасовое количество обновлений и потребление памяти | Успешные завершения, сбои и использование памяти с разделением на группы по часу по времени в формате UTC. |
| Почасовые средней продолжительности | Средняя длительность обновления, разбить на сегменты один час, сообщил в формате UTC. |
| | |
...
1. Щелкните **Управление доступом (IAM)** и добавьте приложение **Power BI Premium** к роли читателя. Если не удается найти приложение по имени, его можно также добавить, идентификатор клиента: `cb4dc29f-0bf4-402a-8b30-7511498ed654`.
