...
Ответ.  С активными подключениями к SSAS MD невозможно выполнять агрегирование на стороне клиента. Сюда входят функции first, last, avg, min, max и sum.
