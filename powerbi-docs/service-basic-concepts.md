...
Для начала прочитайте статью о [предоставлении общего доступа к панелями мониторинга](service-how-to-collaborate-distribute-dashboards-reports.md).
