...
ms.locfileid: "55147457"
---
# <a name="basic-concepts-for-designers-in-the-power-bi-service"></a>Основные понятия для разработчиков в службе Power BI

В этой статье предполагается, что вы уже [зарегистрировались для использования службы Power BI](service-self-service-signup-for-power-bi.md) и [добавили некоторые данные](service-get-data.md). Если у вас пока нет данных, попробуйте установить [пример пакета содержимого Power BI](sample-datasets.md#the-power-bi-samples-as-content-packs).

![Главная страница службы Power BI в браузере](media/service-basic-concepts/power-bi-home-screen.png)

При открытии службы Power BI в браузере отображаются следующие элементы:
...
Либо вы можете просмотреть это видео, прежде чем читать оставшуюся часть статьи.  В этом видео Уилл рассматривает основные понятия, связанные со службой Power BI.
