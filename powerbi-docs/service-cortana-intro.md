...
Это решение основывается на механизме [службы "Поиск Azure" от Майкрософт](). Служба предоставляет такие дополнительные возможности, как интеллектуальное ранжирование, исправление ошибок и автозаполнение.
