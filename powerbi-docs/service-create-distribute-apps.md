...
4. На последней вкладке **Access** укажите, кто имеет доступ к приложению: все сотрудники организации, определенные пользователи или списки рассылки электронной почты. При наличии разрешений можно автоматически установить приложение для получателей.
