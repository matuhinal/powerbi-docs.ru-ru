...
Так как это предварительная версия функции, существуют некоторые ограничения. См. <section link> далее в этой статье, чтобы ознакомиться с текущими ограничениями. В новых рабочих областях мы изменяем некоторые функции. См. раздел < ссылка на раздел > далее в этой статье, чтобы ознакомиться с изменениями, которые будут сохранены.
...
- Публиковать и обновлять приложения.
- Предоставлять совместный доступ к элементам и приложениям.
...
- Рабочие области только для чтения: заменено на ожидаемую роль зрителя, которая имеет доступ только для чтения к содержимому в рабочей области.
