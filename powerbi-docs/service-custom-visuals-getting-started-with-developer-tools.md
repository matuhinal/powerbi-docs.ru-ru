...
Чтобы создать пользовательский визуальный элемент, необходимо установить NodeJS. NodeJS требуется для работы программ командной строки.
...
Чтобы включить динамический просмотр визуального элемента, необходим доверенный сервер HTTPS. Прежде всего необходимо установить SSL-сертификат, позволяющий загружать визуальные ресурсы в веб-браузере. 
...
## <a name="enable-a-live-preview-of-the-developer-visual"></a>Включение динамического просмотра визуального элемента разработчика
...
![Выбор визуального элемента разработчика в Power BI](media/service-custom-visuals-getting-started-with-developer-tools/powerbi-developer-visual-selection.png)
