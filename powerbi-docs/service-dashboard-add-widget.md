...
2. Добавьте сведения об изображении в область **Подробности о плитке** .
...
2. Форматирование текстового поля.
   ...
   * При необходимости задайте настраиваемую ссылку для заголовка.  Однако в этом примере мы добавили гиперссылки в само текстовое поле, поэтому не устанавливайте флажок **Задать пользовательскую связь** .
...
2. Добавьте сведения о видео в область **Подробности о плитке** .
...
2. Добавьте данные в области **Добавление плитки веб-содержимого**.
   ...
   * Нажмите кнопку **Применить**.  На информационной панели измените размер плитки с веб-содержимым или переместите ее (если необходимо).
