...
> [!NOTE]
> Панели мониторинга — это компонент службы Power BI, который недоступен в службе Power BI Desktop. На мобильных устройствах невозможно создавать панели мониторинга, но можно их [просматривать и предоставлять для общего доступа](consumer/mobile/mobile-apps-view-dashboard.md).
> 
> 
