...
4. Службе Power BI необходимо предоставить роли *читателя* и *доступа к данным* в учетной записи хранения.
...
### <a name="grant-the-power-bi-service-reader-and-data-access-roles"></a>Предоставление службе Power BI ролей читателя и доступа к данным
...
В окне **Добавление назначения ролей** выберите роли **Читатель** и **Доступ к данным**, чтобы назначить их службе Power BI. Затем найдите **службу Power BI**. 
