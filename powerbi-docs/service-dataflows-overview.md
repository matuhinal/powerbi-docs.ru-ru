...
См. дополнительные сведения о [настройке рабочих нагрузок потоков данных в Power BI Premium](service-admin-premium-manage.md#configure-workloads).
