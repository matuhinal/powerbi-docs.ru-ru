...
- Пользователи без лицензии Pro могут использовать только отчеты и панели мониторинга, созданные на основе общего набора данных, если обе рабочие области (в одной из которых находится содержимое, а в другой — набор данных) размещены в емкости Premium.
