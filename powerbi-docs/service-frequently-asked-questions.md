...
* Или щелкните значок **Связаться со мной** ![](media/service-frequently-asked-questions/power-bi-contact-me-icon.png) в правом нижнем углу окна браузера.
...
При наличии Power BI и Power BI Desktop можно безопасно подключаться к собственным локальным источникам данных. С помощью шлюза [локального шлюза данных](service-gateway-onprem.md) можно в интерактивном режиме подключаться к локальному серверу служб SQL Server Analysis Services и другим источникам данных. Кроме того, можно назначить запланированное обновление через централизованный шлюз. Если шлюз недоступен, данные из локальных источников можно обновлять с помощью шлюза [Power BI Gateway - Personal](personal-gateway.md).
...
## <a name="power-bi-desktops-software-license-terms-say-you-may-install-and-use-one-copy-of-the-software-on-your-premises"></a>В условиях лицензии на программное обеспечение Power BI Desktop указано, что можно установить и использовать одну его копию в локальной системе.
### <a name="does-this-mean-i-am-limited-to-one-copy-of-power-bi-desktop-for-the-entire-company"></a>Значит ли это, что действует ограничение в одну копию Power BI Desktop на всю организацию?
В правах на использование Power BI Desktop нет ограничения в одну копию приложения на всю организацию. Каждый ее пользователь может установить и использовать одну копию Power BI Desktop на своей локальной системе.
