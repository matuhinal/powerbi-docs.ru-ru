---
title: "Отображение панели мониторинга, плиток на ней и страниц отчетов в полноэкранном режиме"
description: "Отображение панели мониторинга, плиток на ней и страниц отчетов в полноэкранном режиме (*режиме ТВ*)."
services: powerbi
documentationcenter: 
author: mihart
manager: kfile
...
В следующем видео Аманда откроет свою информационную панель и будет перемещаться по ней в полноэкранном режиме, а затем применит некоторые параметры URL-адреса для управления отображением по умолчанию. Затем сделайте то же самое, выполнив пошаговые инструкции, приведенные под видео.
...
2. В полноэкранном режиме есть несколько вариантов меню.  Чтобы открыть меню, просто переместите указатель мыши или курсор. 
    ...
    В отчетах, развернутых во весь экран, используйте эти стрелки для перемещения между страницами.    
