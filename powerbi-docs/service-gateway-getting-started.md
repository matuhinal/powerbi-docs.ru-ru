...
Приветствуем вас в руководстве по **началу работы со шлюзами Power BI**. В этом кратком руководстве вы узнаете о возможностях шлюза, о том, как он действует, а также о том, как установить, настроить и запустить собственный шлюз.  
...
* **Локальный шлюз данных** позволяет нескольким пользователям подключаться к нескольким локальным источникам данных. Один такой шлюз можно использовать в Power BI, **PowerApps**, Flow и в приложениях логики Azure.
