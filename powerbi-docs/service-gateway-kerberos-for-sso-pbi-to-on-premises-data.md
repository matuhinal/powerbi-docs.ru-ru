...
> [!NOTE]
> Чтобы включить единый вход для SAP HANA, необходимо применить следующие два исправления конфигурации SAP HANA:
>    1. Обновите сервер SAP HANA, установив исправление SAP HANA 122.13, выпущенное SAP в конце октября 2017 г. 
...
Необходимо настроить **ограниченное делегирование Kerberos** с транзитом протокола. При помощи ограниченного делегирования определите службы, которые нужно делегировать. Например, только сервер SQL Server или сервер SAP HANA будут получать вызовы делегирования от учетной записи службы шлюза.
