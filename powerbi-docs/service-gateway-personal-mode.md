...
* Новая версия личного шлюза называется **Локальный шлюз данных (персональный режим)**. В ней используется значок шлюза (облако со стрелкой вверх и вниз в нижней части).
...
* Я использую сценарий R. Он поддерживается?
  ...
  * **Ответ.** Скрипты R поддерживаются в персональном режиме.
