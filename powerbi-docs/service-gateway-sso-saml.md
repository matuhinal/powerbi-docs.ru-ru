...
Также обратите внимание, что, хотя в этом руководстве в качестве поставщика служб шифрования сервера HANA используется OpenSSL, вы также можете использовать рекомендуемую компанией SAP библиотеку шифрования SAP (также известную как CommonCryptoLib или sapcrypto) вместо OpenSSL, чтобы завершить установку отношения доверия во время настройки. Дополнительные сведения см. в официальной документации по SAP.
