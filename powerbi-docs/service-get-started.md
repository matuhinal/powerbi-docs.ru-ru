...
2. Компонент выполнит поиск ответа и представит его в виде визуализации. Щелкните значок закрепления ![](media/service-get-started/pbi_pinicon.png), чтобы показать эту визуализацию на панели мониторинга.
