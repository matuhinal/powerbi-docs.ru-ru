...
7. Обратите внимание, что области навигации сверху доступен **Режим чтения**. Если этот параметр отображается, значит, вы сейчас находитесь в режиме правки. Чтобы лучше ознакомиться с редактором отчетов, см. [эту статью](service-the-report-editor-take-a-tour.md).
