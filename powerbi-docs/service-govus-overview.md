...
description: Клиенты из государственных учреждений США могут присоединять подписки Power BI Pro к своим планам Office 365 для государственных организаций. Узнайте, как зарегистрироваться и проверить доступность функций, в описании этой службы.
author: kfollis
ms.reviewer: ''
ms.service: powerbi
...
После развертывания Office 365 можно добавить подписку Power BI. Чтобы приобрести службу Power BI Pro для государственных организаций, выполните пошаговые указания по [регистрации своей государственной организации США](service-govus-signup.md#existing-office-government-cloud-customers). Купите необходимое количество лицензий для всех пользователей Power BI, а затем назначьте эти лицензии отдельным учетным записям.

> [!IMPORTANT]
> Служба Power BI для государственных организаций США недоступна по бесплатной лицензии. Чтобы у пользователей был доступ к облаку сообщества для государственных организаций, каждому из них необходимо назначить лицензию Pro. Если учетной записи назначена бесплатная лицензия, у пользователя этой записи будет право доступа только к коммерческому облаку. Кроме того, он столкнется с проблемами проверки подлинности и доступа. Сведения о различиях между типами лицензий см. в статье [Функции службы Power BI по типам лицензий](service-features-license-type.md).
>
>
...
|  |Отчеты с разбивкой на страницы|Доступно только в USGov Техаса и Вирджинии |Доступно|В стратегическом плане|
...
|  |Подключение к CDS|Недоступно|Недоступно|Недоступно|
|  |Соединитель Azure Data Lake Storage 2-го поколения|Недоступно|Недоступно|Недоступно|
...
|  |Вкладка Power BI в Teams|Недоступно|Недоступно|Недоступно|
