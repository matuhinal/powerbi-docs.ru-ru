...
| Создавать отчеты в другой рабочей области на основе набора данных в этой рабочей области. |  X | X  | X  |   |
| Копировать отчет. | X | X | X |  |
| Просматривать элемент и работать с ним. |  X | X  | X  | X  |

> [!NOTE]
>Чтобы копировать отчеты и создавать в другой рабочей области новые отчеты, основанные на наборе данных из этой рабочей области, пользователи должны соответствовать дополнительным критериям.
>- Наличие лицензии Power BI Pro. Дополнительные сведения см. в следующем разделе: [Лицензирование](#licensing).
>- Наличие разрешений на сборку для набора данных. В отношении наборов данных из этой рабочей области пользователи с ролями администратора, члена или участника получают разрешения на сборку в рамках роли рабочей области.
