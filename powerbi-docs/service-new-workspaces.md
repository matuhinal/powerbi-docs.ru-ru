---
title: Организация работы в новых рабочих областях — Power BI
...
В новых рабочих областях мы изменяем некоторые функции. Ниже приведены изменения, которые будут сохранены. 
...
- Чтобы разрешить пользователям с ролью зрителя экспортировать данные, назначьте им разрешение на сборку для наборов данных в рабочей области.
