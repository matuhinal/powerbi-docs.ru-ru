...
Назначать рабочие области для емкости Premium можно на портале администрирования Power BI или на панели **Рабочая область** (для рабочих областей приложений).
