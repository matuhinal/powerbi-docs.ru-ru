...
По умолчанию возможность подключения к конечной точке XMLA включена для рабочей нагрузки наборов данных. Ее можно отключить в разделе [Параметры рабочей нагрузки](service-admin-premium-workloads.md#workload-settings).
