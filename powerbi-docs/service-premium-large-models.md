...
- **Поддерживаемые регионы**: Большие модели поддерживаются во всех регионах Azure, в которых поддерживается хранилище файлов класса Premium. См. сведения о [доступности продуктов по регионам](https://azure.microsoft.com/global-infrastructure/services/?products=storage).
