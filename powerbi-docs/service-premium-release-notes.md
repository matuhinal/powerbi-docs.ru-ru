...
* Все пользователи, независимо от назначенных им лицензий, теперь могут просматривать панели мониторинга, к которым им предоставлен доступ из рабочих областей Power BI Premium.
