...
Можно воспользоваться преимуществами Power BI Premium, назначив рабочие области в емкость Premium. *Емкость Premium* — это выделенный ресурс вашей организации. Рабочие области, не назначенные в емкость Premium, находятся в общей емкости.
...
По умолчанию рабочая область находится в общей емкости. Это относится к вашей личной рабочей области *Моя рабочая область* и приложениям в ней. Общая емкость — это среда Power BI, в которой ваши рабочие нагрузки выполняются на вычислительных ресурсах, совместно используемых другими пользователями.
