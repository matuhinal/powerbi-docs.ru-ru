...
* Каждый визуальный элемент из отчета Power BI экспортируется в PowerPoint как изображение с высоким разрешением.
...
Открывая слайды по очереди, вы увидите, что каждый визуальный элемент представлен отдельным изображением (как упоминалось ранее). Таким образом, любое изображение можно скопировать и вставить в другой слайд, документ или расположение.
