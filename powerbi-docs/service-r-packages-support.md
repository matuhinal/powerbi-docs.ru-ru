...
Пакеты, поддерживаемые R для использования в **службе Power BI**, перечислены в разделе **Поддерживаемые пакеты**. Чтобы запросить поддержку для пакета R, который отсутствует в списке, опубликуйте запрос на сайте [Power BI Ideas](https://ideas.powerbi.com).
...
|в любое время|0.3.3|https://cran.r-project.org/web/packages/anytime/index.html|
...
|знак вставки|6.0-78|https://cran.r-project.org/web/packages/caret/index.html|
...
|наборы данных|3.4.4|NA|
|дата|1.2-38|https://cran.r-project.org/web/packages/date/index.html|
...
|Матрица|1.2-12|https://cran.r-project.org/web/packages/Matrix/index.html|
...
|Снежно-белый|0.4–2|https://cran.r-project.org/web/packages/snow/index.html|
...
|спам|2.1-3|https://cran.r-project.org/web/packages/spam/index.html|
