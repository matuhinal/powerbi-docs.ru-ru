...
| [Использование панели "Фильтры" в отчетах](power-bi-how-to-report-filter.md) | Да, можно использовать существующие фильтры, при этом изменения сохраняются вместе с отчетом, однако добавлять новые фильтры запрещено. | Да |
