...
> [!NOTE]
> В [этой статье](https://docs.microsoft.com/power-bi/developer/api-rest-api-limitations) приведены сведения об ограничениях на объем **отправляемых** данных.
> 
> 
