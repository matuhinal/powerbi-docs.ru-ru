...
ms.locfileid: "34723030"
---
# <a name="subscribe-to-a-report-or-dashboard-in-power-bi-service-apppowerbicom"></a>Подписка на отчеты и панели мониторинга в службе Power BI (app.powerbi.com)
...
Для электронной почты и моментальных снимков будет использоваться язык, заданный в параметрах Power BI (см. статью [Поддерживаемые языки и страны (регионы) для Power BI](supported-languages-countries-regions.md)). Если язык не задан, в Power BI используется язык, установленный в текущем браузере. Чтобы просмотреть или настроить параметры языка, выберите значок шестеренки ![значок шестеренки](media/service-report-subscribe/power-bi-settings-icon.png) **> Параметры > Общие > Язык**. 
...
3. Для включения и отключения подписки используйте ползунок желтого цвета.  Установив ползунок в положение "Выкл.", вы не удалите подписку. Для удаления подписки выберите значок корзины.
   ...
   ![Окно подписки](media/service-report-subscribe/power-bi-subscribe-dashboard-new.png)
4. Чтобы сохранить подписку, щелкните **Сохранить и закрыть**. Вы будете получать моментальный снимок панели мониторинга по электронной почте при каждом изменении базовых наборов данных. Если панель мониторинга обновляется несколько раз в день, вы получите по электронной почте только тот моментальный снимок, который создан после первого обновления.
   ...
   ![Отправка по электронной почте моментального снимка панели мониторинга](media/service-report-subscribe/power-bi-dashboard-email-new.png)
   
   > [!TIP]
   > Хотите получить сообщение электронной почты прямо сейчас? Активируйте сообщение электронной почты, обновив один из наборов данных, связанных с панелью мониторинга. Если у вас нет разрешений на изменение набора данных, попросите пользователя с соответствующими правами сделать это для вас. Чтобы узнать, какие наборы данных использовались для создания панели мониторинга, щелкните значок **просмотра связанных элементов** ![значок просмотра связанных элементов](media/service-report-subscribe/power-bi-view-related.png), чтобы открыть окно **связанного содержимого**, а затем щелкните значок обновления ![значок обновления](media/service-report-subscribe/power-bi-refresh.png). 
   > 
   > 
...
1. Откройте отчет в [режиме чтения](service-reading-view-and-editing-view.md).
...
3. За один раз можно подписаться на одну страницу отчета. В раскрывающемся списке выберите конкретную страницу отчета.
   ...
   ![Окно подписки](media/service-report-subscribe/power-bi-subscribe-dialog.png)
...
4. Чтобы включить или отключить подписку для каждой страницы, используйте ползунок желтого цвета.  Установив ползунок в положение "Выкл.", вы не удалите подписку. Для удаления подписки выберите значок корзины.
   ...
   ![Включение подписки](media/service-report-subscribe/power-bi-slider.png)
5. Чтобы сохранить подписку, щелкните **Сохранить и закрыть**. Когда отчет будет обновлен, вы получите по электронной почте моментальный снимок каждой его страницы. В дни, когда отчет не обновляется, вы не будете получать моментальные снимки по электронной почте.  Если отчет обновляется несколько раз в день, вы получите по электронной почте только тот моментальный снимок, который создан после первого обновления.
   ...
   ![Отправка по электронной почте моментального снимка панели мониторинга](media/service-report-subscribe/power-bi-subscription-email.png)
   ...
   > 
   > ![Значок "Обновить сейчас" на вкладке наборов данных](media/service-report-subscribe/power-bi-refresh-now.png)
   > 
   > 
...
Открыть экран для управления подписками можно двумя способами.  Первый способ: в диалоговом окне **Оформление подписки на рассылку по электронной почте** можно выбрать параметр **Управление всеми подписками** (см. шаг 3 выше). Второй способ: в верхней строке меню щелкните значок шестеренки ![значок шестеренки](media/service-report-subscribe/power-bi-settings-icon.png) Power BI и выберите **Settings** (Параметры).
...
* Отправленные отчеты и панели мониторинга используют параметр языка Power BI. Язык по умолчанию — английский. Чтобы просмотреть или настроить параметры языка, выберите значок шестеренки ![значок шестеренки](media/service-report-subscribe/power-bi-settings-icon.png) **> Параметры > Общие > Язык**.
