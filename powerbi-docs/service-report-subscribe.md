...
* Для подписки по электронной почте доступны только заданные по умолчанию и [сертифицированные визуальные элементы Power BI](developer/visuals/power-bi-custom-visuals.md).  
