...
Отчеты — это компонент службы Power BI и Power BI Desktop. Возможности работы с отчетами практически идентичны. Однако на мобильных устройствах нельзя создавать отчеты, но вы можете [просматривать и совместно использовать отчеты, а также добавлять к ним комментарии](consumer/mobile/mobile-reports-in-the-mobile-apps.md).
