...
> [!NOTE]
> Возможность индивидуальной регистрации может быть отключена для пользователей организации. Если вы получаете сообщение об ошибке с подобным уведомлением, см. статью [Возможность индивидуальной регистрации отключена](#individual-sign-up-has-been-turned-off).
> 
> 

## <a name="what-you-need-to-sign-up"></a>Что необходимо для регистрации
Чтобы зарегистрироваться в Power BI, необходим рабочий электронный адрес. Личный электронный адрес не подходит для службы Power BI.
...
Для регистрации в службе Power BI необходим рабочий или учебный адрес электронной почты. Power BI не поддерживает адреса, предоставляемые службами личной электронной почты или поставщиками телекоммуникационных услуг. К их числу относятся платформы outlook.com, hotmail.com, gmail.com и т. д.
...
> [!NOTE]
> В настоящее время Power BI не поддерживает самостоятельную регистрацию в доменах .gov или .mil. Обратитесь к администратору Office 365.
> 
> 
