...
Независимо от того, где вы предоставляете общий доступ к своему содержимому, внутри или за пределами вашей организации, вам требуется [лицензия Power BI Pro](service-features-license-type.md). Получателям содержимого также требуются лицензии Power BI Pro либо же содержимое должно находиться в [емкости Premium](service-premium.md). 
...
2. В поле сверху введите адреса электронной почты сотрудников, групп рассылки или групп безопасности. Доступ для динамических списков рассылки предоставить нельзя. 
   ...
   >[!NOTE]
   >Поле ввода поддерживает не более 100 пользователей или групп. Общий доступ можно предоставлять несколько раз. Также можно предоставлять доступ группе пользователей.
   > 
   > 
...
Если для гостевых пользователей включен параметр [Разрешение внешним гостям отслеживать и изменять содержимое в организации](service-admin-portal.md#export-and-sharing-settings), типовая процедура, основанная только на потреблении, к ним не применяется. [Дополнительные сведения](service-admin-azure-ad-b2b.md)
