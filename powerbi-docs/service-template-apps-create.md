...
2. В разделе **Создание рабочей области приложения** выберите **Перейти на новую**.
...
Как и при использовании обычной рабочей области приложения Power BI, следующим шагом является создание в ней содержимого.  
