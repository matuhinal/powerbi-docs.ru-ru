...
Новые *приложения-шаблоны* Power BI позволяют партнерам создавать приложения Power BI с минимальным количеством кода или вообще без него и развертывать их для любых клиентов. Эта статья предназначена для аналитиков Power BI. Она содержит сведения об установке, настройке и распространении приложения-шаблона, созданного партнером Power BI. Если вас интересует создание приложений-шаблонов для самостоятельного распространения, см. статью [Создание приложения-шаблона в Power BI](service-template-apps-create.md).

![Установленные приложения Power BI](media/service-template-apps-install-distribute/power-bi-get-apps.png)

После установки приложения-шаблона, созданного партнером Power BI, вы можете изменять его под потребности своей организации, а затем распространять в виде обычного приложения среди коллег.  
