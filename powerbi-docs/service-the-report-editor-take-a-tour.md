...
ms.locfileid: "53983653"
---
# <a name="tour-of-the-report-editor-in-power-bi"></a>Обзор редактора отчетов в Power BI
...
Разработчики отчетов создают и изменяют панели мониторинга и отчеты. Затем они передают их пользователям отчетов. Пользователи могут работать с панелями мониторинга и отчетами в режиме чтения в службе Power BI, но не могут изменять их. Узнайте больше о разнице между [режимами чтения и правки отчетов в службе Power BI](consumer/end-user-reading-view.md). 
