...
Для специальных символов и пробелов требуется дополнительное форматирование. Если запрос содержит пробелы, дефисы или другие символы не из набора ASCII, предварите эти специальные символы *escape-кодом* в следующем формате: символ подчеркивания и X (**_x**), 4-значный символ **Юникода** и еще один символ подчеркивания. Если символ Юникода содержит менее 4 знаков, заполните его нулями. Ниже приведено несколько примеров.
