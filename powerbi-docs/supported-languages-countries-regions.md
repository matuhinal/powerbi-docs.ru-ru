...
ms.locfileid: "61399102"
---
# <a name="supported-languages-and-countriesregions-for-power-bi"></a>Поддерживаемые языки и страны (регионы) для Power BI

В этой статье перечислены поддерживаемые языки и страны/регионы для службы Power BI, Power BI Desktop и документации по Power BI.
...
Power BI преобразует меню, кнопки, сообщения и другие элементы интерфейса в вашем языке.

В настоящее время следующие возможности доступны только на английском языке:

* Панели мониторинга и отчетам Power BI создает при подключении к службам, например Microsoft Dynamics CRM, Salesforce и Google Analytics. По-прежнему можно создать собственные панели мониторинга и отчеты на вашем языке.
...
Независимо от способа установки Power BI Desktop, вы можете выбрать языковой стандарт для отдельного отчета, отличный от языкового стандарта в вашей версии Power BI Desktop. Изменения языкового стандарта, интерпретируется как данные, при импорте из данных источника, например ли «3/4/2017» интерпретируется как 3 апреля или 4 марта. 
