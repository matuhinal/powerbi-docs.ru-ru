...
Служба Power BI (в браузере) доступна на 42 языках:
...
Получить Power BI Desktop можно одним из двух способов: скачать или установить из Магазина Windows.
...
* Вы также можете [выбрать язык, который будет использоваться при импорте данных,](#choose-the-locale-to-be-used-when-importing-data-into-power-bi-desktop) для определенного отчета. 
...
### <a name="choose-the-locale-to-be-used-when-importing-data-into-power-bi-desktop"></a>Выбор языкового стандарта, используемого при импорте данных в Power BI Desktop
...
3. В поле **Языковой стандарт** выберите другой язык. 
   
   ![Диалоговое окно "Параметры" в Power BI Desktop](media/supported-languages-countries-regions/pbi_supptdlangs_locale.png)
4. Нажмите кнопку **ОК**.
...
* Вы используете одно из мобильных приложений Power BI? См. дополнительные сведения о [поддерживаемых языках в мобильных приложениях Power BI](mobile-apps-supported-languages.md).
