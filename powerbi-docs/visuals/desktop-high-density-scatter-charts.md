...
Начиная с выпуска **Power BI Desktop** за сентябрь 2017 года, доступен новый алгоритм выборки. Он улучшает презентацию данных с высокой плотностью в точечных диаграммах.
...
![пример точечной диаграммы](media/desktop-high-density-scatter-charts/high-density-scatter-charts-01.png)
...
* Если щелкнуть правой кнопкой мыши значение под элементом **Сведения**, а затем в открывшемся меню выбрать команду **Показать элементы без данных**, точечная диаграмма вернется к исходному алгоритму.
  ...
  ![пример отображения элементов без данных](media/desktop-high-density-scatter-charts/high-density-scatter-charts-02.png)
...
* Если использовать параметр **Линия отношения** на панели **Аналитика**, диаграмма вернется к исходному алгоритму.
  ...
  ![пример использования линии отношения](media/desktop-high-density-scatter-charts/high-density-scatter-charts-03.png)
...
![пример выборки высокой плотности](media/desktop-high-density-scatter-charts/high-density-scatter-charts-04.png)
...
* [Выборка линий с высокой плотностью в Power BI](../create-reports/desktop-high-density-sampling.md)
