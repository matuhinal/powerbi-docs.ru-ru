...
* Если для карт (пузырьковых карт) указана широта или долгота, то данные не будут отправлены в Bing. В противном случае все данные в контейнерах **расположения** (и фильтра) будут отправлены в Bing.     
