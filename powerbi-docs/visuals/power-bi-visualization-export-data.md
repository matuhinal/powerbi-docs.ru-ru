...
ms.locfileid: "49112275"
---
# <a name="export-data-from-visualizations"></a>Экспорт данных из визуализаций
Чтобы просмотреть данные, которые используются для создания визуализации, откройте их в Power BI или экспортируйте в Excel в виде файла XLSX или CSV.   
...
- Разрешение экспортировать только сводные данные (это значение по умолчанию для отчетов). 
- Разрешение экспортировать сводные и базовые данне.х  
