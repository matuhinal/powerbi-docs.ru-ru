...
- Авторы отчетов могут классифицировать и помечать отчеты с помощью [меток конфиденциальности](../admin/service-security-data-protection-overview.md) Microsoft Information Protection. Если метка конфиденциальности имеет параметры защиты, Power BI применит их при экспорте данных отчета в файлы Excel, PowerPoint или PDF. Защищенные файлы могут открыть только авторизованные пользователи.
...
Конструкторы отчетов Power BI управляют типами параметров экспорта данных, которые доступны для пользователей. Возможные варианты:
