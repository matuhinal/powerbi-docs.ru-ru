...
1. Для создания собственной картограммы [скачайте пример "Продажи и маркетинг"](../sample-datasets.md), выполнив вход в Power BI и выбрав **Получение данных \> Примеры \> Sales and Marketing (Продажи и маркетинг) \> Подключиться**. Или получите приложение **"Продажи и маркетинг" Power BI** на сайте appsource.com. 

2. Откройте отчет "Продажи и маркетинг".

   ![Открывается отчет "Продажи и маркетинг"](media/power-bi-visualization-filled-maps-choropleths/power-bi-report-canvas.png)
