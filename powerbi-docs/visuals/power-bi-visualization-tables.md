...
* Power BI вычисляет максимальный размер ячейки на основе первых 20 столбцов и первых 50 строк. Ячейки за пределами этих точек могут иметь неподходящий размер.
