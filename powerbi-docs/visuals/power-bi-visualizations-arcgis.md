...
* Как и для других типов визуализаций, потребители Power BI категории **Pro** могут делать все то, что доступно потребителю категории "Премиум", а также [экспортировать базовые данные](power-bi-visualization-export-data.md), [получать метрики использования](../service-usage-metrics.md), сохранять копии для [публикации в Интернете](../service-publish-to-web.md) и многое другое.
