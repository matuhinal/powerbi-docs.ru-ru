...
* Как и для других типов визуализации, вы можете [закреплять на панелях мониторинга](../service-dashboard-pin-tile-from-report.md), [просматривать](../consumer/end-user-show-data.md) и (или) [экспортировать базовые данные](power-bi-visualization-export-data.md), а также использовать [режим фокусировки](../consumer/end-user-focus.md) и [полноэкранный режим](../service-fullscreen-mode.md).    
