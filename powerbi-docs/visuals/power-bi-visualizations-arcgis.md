...
![Карта ArcGIS, на которой показаны Соединенные Штаты Америки с пузырьками, маркерами и временем поездок](media/power-bi-visualizations-arcgis/power-bi-arcgis-esri-new.png)
...
![Снимок экрана всех трех инструментов выделения](media/power-bi-visualizations-arcgis/power-bi-esri-selection-tools2.png)

![Снимок экрана инструмента единичного выделения](media/power-bi-visualizations-arcgis/power-bi-esri-selection-single2.png) Позволяет выбрать отдельные точки данных.

![Инструмент множественного выбора](media/power-bi-visualizations-arcgis/power-bi-esri-selection-marquee2.png) Позволяет начертить прямоугольник на карте и выбрать точки данных, содержащиеся в нем. Несколько прямоугольных областей можно выбрать с помощью клавиши CTRL.

![Третий инструмент выделения для границ](media/power-bi-visualizations-arcgis/power-bi-esri-selection-reference-layer2.png) Позволяет использовать границы или многоугольники в ссылочных слоях для выбора содержащихся в них точек данных.

<br/>

## <a name="interacting-with-an-arcgis-map"></a>Взаимодействие с картой ArcGIS
Набор доступных функций зависит от вашей роли: *автор* (вы создали карту) или *потребитель* (вам предоставили общий доступ к карте ArcGIS). При взаимодействии с картой ArcGIS в качестве потребителя (т. е. в [режиме чтения](../consumer/end-user-reading-view.md)) доступны описанные ниже действия.
...
* Разверните область **Фильтры**, чтобы применять фильтры при работе с картой.   
    ![Панель "Фильтры"](media/power-bi-visualizations-arcgis/power-bi-filter-newer.png)  
* Если карта содержит ссылочный слой, выберите расположения для отображения сведений в подсказке. Здесь мы выбрали округ Адамс и видим добавленный автором ссылочный слой с данными по среднестатистическому доходу населения.
    ...
    ![Подсказка об округе Адамс](media/power-bi-visualizations-arcgis/power-bi-reference-layer.png)  
    ...
    ![Подсказка к столбцу диаграммы на исходной подсказке](media/power-bi-visualizations-arcgis/power-bi-tooltip-chart.png)
...
* Наведите указатель мыши на символы расположения на базовой карте, чтобы отобразились сведения подсказки.     
  ![Подсказка к расположению](media/power-bi-visualizations-arcgis/power-bi-arcgis-hover.png)
...
* Если автор добавил в карту ArcGIS слой инфографики, в правом верхнем углу карты отобразятся дополнительные данные.  Например, в этом случае автор карты добавил категорию "Дети до 14 лет".
    ...
    ![Карта со слоем инфографики](media/power-bi-visualizations-arcgis/power-bi-demographics.png)
