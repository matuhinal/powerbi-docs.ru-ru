...
Когда в правой части холста **отчета** появится область **Визуализации** , можно приступать к настройке. Если панель не отображается, щелкните стрелку в правом верхнем углу, чтобы открыть эту панель.
