...
Чтобы внести изменения, необходимо открыть отчет в режиме редактирования: выберите нужный **отчет** в области **Моя рабочая область** , а затем выберите пункт **Изменить отчет** в верхнем меню, как показано на следующем рисунке. В этом примере используется **образец "Управление персоналом"**.

![холст отчета с выделенным пунктом "Изменить отчет"](media/service-tips-and-tricks-for-color-formatting/power-bi-edit.png)

Когда в правой части холста **отчета** появится область **Визуализации** , можно приступать к настройке.

![отчет с отображаемой областью форматирования](media/service-tips-and-tricks-for-color-formatting/power-bi-formatting-pane.png)

## <a name="change-the-color-of-a-single-data-point"></a>Изменение цвета отдельной точки данных
Иногда требуется выделить одну точку данных. Возможно, это объемы продаж для запуска нового продукта или повышенные показатели качества после запуска новой программы. С помощью Power BI для большинства типов визуальных элементов можно выделить конкретную точку данных, изменив ее цвет.

В представленной ниже визуализации отображается маржа от продаж по сотрудникам с использованием цветов по умолчанию. 

![диаграмма с областями](media/service-tips-and-tricks-for-color-formatting/power-bi-area-chart.png)

Область для сотрудника Annelie плохо видна, поэтому давайте выделим ее другим цветом. Это делается следующим образом.

Разверните раздел **Цвета данных** . Появятся следующие элементы.

![Область выбора "Цвета данных" под областью форматирования](media/service-tips-and-tricks-for-color-formatting/power-bi-data-colors.png)


В этом случае давайте выберем темный, но яркий цвет, который отличается от цвета, применяемого для пользователя Valery. Щелкните стрелку вниз в поле выбора цвета для пользователя Annelie, выберите пункт **Настраиваемый цвет**, а затем выберите ярко-синий цвет.

![выбор цвета](media/service-tips-and-tricks-for-color-formatting/tipstrickscolor_6.png)

После выбора цвета область пользователя Annelie ясно отличается от областей других сотрудников. 

![диаграмма с областями, область пользователя Annelie теперь ярко-синяя](media/service-tips-and-tricks-for-color-formatting/power-bi-color.png)
