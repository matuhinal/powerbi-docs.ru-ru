...
**Применимо к:** емкости службы Power BI, Power BI Premium и Azure Power BI Embedded.
...
Существует несколько общих рекомендаций, которые помогут вам оптимизировать потребление и производительность. Сюда входит следующее.
