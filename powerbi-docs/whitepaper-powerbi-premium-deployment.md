...
Если у вас уже есть емкость и отчеты, для которых требуется загрузить нагрузочный тест, для быстрого создания нагрузочного теста используйте [средство создания нагрузки PowerShell](https://aka.ms/PowerBILoadTestingTool) . Это средство позволяет оценить, сколько экземпляров каждого отчета может выполняться в течение часа. С помощью этого средства можно оценить способность мощности для подготовки к просмотру отдельных отчетов или для параллельного отображения нескольких разных отчетов. Дополнительные сведения см. в видеоролике [Майкрософт Power BI: Емкость](https://www.youtube.com/watch?time_continue=1860&v=C6vk6wk9dcw)Premium.

Чтобы создать более сложный тест, рассмотрите возможность разработки приложения нагрузочного тестирования, моделирующего реалистичную рабочую нагрузку. Дополнительные сведения см. в веб-семинаре [нагрузочное тестирование Power BI приложений с помощью нагрузочного теста Visual Studio](https://blogs.msdn.microsoft.com/charles_sterling/2018/04/04/webinar-load-testing-power-bi-applications-with-visual-studio-load-test/).
