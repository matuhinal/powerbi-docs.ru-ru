...
## <a name="introducing-power-bi-premium"></a>Знакомство с Power BI Premium
...
Мониторинг емкостей Premium предоставляет администраторам сведения о выполнении емкостей. Емкость можно отслеживать с помощью [приложения метрики емкости Power BI Premium](service-admin-premium-monitor-capacity.md) или [портал администрирования Power BI](service-admin-premium-monitor-portal.md).
