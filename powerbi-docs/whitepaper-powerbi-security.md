...
1. Данные
    ...
    . Отправка данных версии 2 — данные хранятся зашифрованными в SQL Azure.
...
3. Учетные данные для исходных источников данных
    ...
    . Извлечение, преобразование и загрузка — нет (ничего не хранится на вычислительном узле и не отличается от ситуации, описанной в разделе **Неактивные данные** выше)
4. Данные
...
| **Поддержка CBA** | для **iOS**; | для **Android**; | **Windows** |
| --- | --- | --- | --- |
| **Power BI** (вход в службу) | поддерживаемое количество | поддерживаемое количество | Не поддерживается |
